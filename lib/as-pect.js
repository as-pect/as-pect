(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./test/TestContext", "./test/TestGroup", "./test/TestReporter", "./test/TestResult", "./reporter/DefaultTestReporter", "./reporter/EmptyReporter", "./reporter/SummaryTestReporter", "./util/ActualValue", "./util/LogValue", "./cli"], factory);
    }
