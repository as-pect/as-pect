...
(function (factory) {
    ...
    var DefaultTestReporter = /** @class */ (function (_super) {
        ...
        DefaultTestReporter.prototype.onGroupStart = function (group) {
            this.suite.stdout.write(chalk_1.default(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n[Describe]: ", "\n\n"], ["\\n[Describe]: ", "\\n\\n"])), group.name));
        ...
        DefaultTestReporter.prototype.onTestFinish = function (_group, test) {
            if (test.pass) {
                this.suite.stdout.write(chalk_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject([" {green [Success]: \u2714} ", "\n"], [" {green [Success]: \u2714} ", "\\n"])), test.name));
            }
            else {
                this.suite.stdout.write(chalk_1.default(templateObject_9 || (templateObject_9 = __makeTemplateObject(["    {red [Fail]: \u2716} ", "\n"], ["    {red [Fail]: \u2716} ", "\\n"])), test.name));
                if (!test.negated) {
                ...
                if (test.message) {
                    this.suite.stdout.write(chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["  [Message]: {yellow ", "}\n"], ["  [Message]: {yellow ", "}\\n"])), test.message));
                }
                if (test.stack) {
            ...
            if (test.performance) {
                this.suite.stdout.write(chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject([" {yellow [Samples]}: ", " runs\n"], [" {yellow [Samples]}: ", " runs\\n"])), test.times.length.toString()));
                // log statistics
                if (test.hasAverage) {
                    this.suite.stdout.write(chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["    {yellow [Mean]}: ", "ms\n"], ["    {yellow [Mean]}: ", "ms\\n"])), test.average.toString()));
                }
                if (test.hasMedian) {
                    this.suite.stdout.write(chalk_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["  {yellow [Median]}: ", "ms\n"], ["  {yellow [Median]}: ", "ms\\n"])), test.median.toString()));
                }
                if (test.hasVariance) {
                    this.suite.stdout.write(chalk_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["{yellow [Variance]}: ", "ms\n"], ["{yellow [Variance]}: ", "ms\\n"])), test.variance.toString()));
                }
                if (test.hasStdDev) {
                    this.suite.stdout.write(chalk_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["  {yellow [StdDev]}: ", "ms\n"], ["  {yellow [StdDev]}: ", "ms\\n"])), test.stdDev.toString()));
                }
                if (test.hasMax) {
                    this.suite.stdout.write(chalk_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["     {yellow [Max]}: ", "ms\n"], ["     {yellow [Max]}: ", "ms\\n"])), test.max.toString()));
                }
                if (test.hasMin) {
                    this.suite.stdout.write(chalk_1.default(templateObject_17 || (templateObject_17 = __makeTemplateObject(["     {yellow [Min]}: ", "ms\n"], ["     {yellow [Min]}: ", "ms\\n"])), test.min.toString()));
                }
            }
            else {
                // log the log values
        ...
        DefaultTestReporter.prototype.onFinish = function (suite) {
            ...
            this.suite.stdout.write("\n" + "~".repeat(process.stdout.columns - 10) + "\n\n    [File]: " + suite.fileName + "\n  [Groups]: " + suite.testGroups.filter(function (e) { return e.pass; }).length.toString() + " pass, " + suite.testGroups.length.toString() + " total\n  [Result]: " + result + "\n [Summary]: " + successCount.toString() + " pass,  " + fail + ", " + count.toString() + " total\n [Startup]: " + suite.startupTime.toString() + "ms\n    [Time]: " + suite.time.toString() + "ms\n");
        };
        DefaultTestReporter.prototype.onTodo = function (_group, todo) {
            this.suite.stdout.write(chalk_1.default(templateObject_21 || (templateObject_21 = __makeTemplateObject(["    {yellow [Todo]:} ", "\n"], ["    {yellow [Todo]:} ", "\\n"])), todo));
        };
        /**
        ...
        DefaultTestReporter.prototype.onLog = function (logValue) {
            ...
            if (logValue.pointer > 0) {
                this.suite.stdout.write(chalk_1.default(templateObject_22 || (templateObject_22 = __makeTemplateObject(["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", "\n"], ["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", "\\n"])), pointer, hexPointer, logValue.message));
            }
            else {
                this.suite.stdout.write(chalk_1.default(templateObject_23 || (templateObject_23 = __makeTemplateObject(["     {yellow [Log]:} ", "\n"], ["     {yellow [Log]:} ", "\\n"])), logValue.message));
            }
            ...
            if (logValue.bytes.length > 0) {
                ...
                this.suite.stdout.write(chalk_1.default(templateObject_24 || (templateObject_24 = __makeTemplateObject(["            {blueBright ", "}\n"], ["            {blueBright ", "}\\n"])), value.split("\n").join("\n            ")));
            }
            this.suite.stdout.write(chalk_1.default(templateObject_25 || (templateObject_25 = __makeTemplateObject(["        {yellow ", "}\n\n"], ["        {yellow ", "}\\n\\n"])), logValue.stack.split("\n").join("\n        ")));
        };
