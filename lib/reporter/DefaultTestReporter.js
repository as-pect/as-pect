...
(function (factory) {
    ...
    var DefaultTestReporter = /** @class */ (function (_super) {
        ...
        DefaultTestReporter.prototype.onFinish = function (suite) {
            ...
            console.log("");
            console.log(chalk_1.default(templateObject_22 || (templateObject_22 = __makeTemplateObject(["    [File]: ", ""], ["    [File]: ", ""])), suite.fileName));
            ...
            console.log(chalk_1.default(templateObject_26 || (templateObject_26 = __makeTemplateObject([" [Startup]: ", "ms"], [" [Startup]: ", "ms"])), suite.startupTime.toString()));
            console.log(chalk_1.default(templateObject_27 || (templateObject_27 = __makeTemplateObject(["    [Time]: ", "ms"], ["    [Time]: ", "ms"])), suite.time.toString()));
            console.log("");
        };
        DefaultTestReporter.prototype.onTodo = function (_group, todo) {
            console.log(chalk_1.default(templateObject_28 || (templateObject_28 = __makeTemplateObject(["    {yellow [Todo]:} ", ""], ["    {yellow [Todo]:} ", ""])), todo));
        };
        /**
        ...
        DefaultTestReporter.prototype.onLog = function (logValue) {
            ...
            if (logValue.pointer > 0) {
                console.log(chalk_1.default(templateObject_29 || (templateObject_29 = __makeTemplateObject(["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", ""], ["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", ""])), pointer, hexPointer, logValue.message));
            }
            else {
                console.log(chalk_1.default(templateObject_30 || (templateObject_30 = __makeTemplateObject(["     {yellow [Log]:} ", ""], ["     {yellow [Log]:} ", ""])), logValue.message));
            }
            ...
            if (logValue.bytes.length > 0) {
                ...
                console.log(chalk_1.default(templateObject_31 || (templateObject_31 = __makeTemplateObject(["            {blueBright ", "}"], ["            {blueBright ", "}"])), value.split("\n").join("\n            ")));
            }
            console.log(chalk_1.default(templateObject_32 || (templateObject_32 = __makeTemplateObject(["        {yellow ", "}\n"], ["        {yellow ", "}\\n"])), logValue.stack.split("\n").join("\n        ")));
        };
