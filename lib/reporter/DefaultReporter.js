    ...
    var DefaultReporter = /** @class */ (function (_super) {
        ...
        DefaultReporter.prototype.onLog = function (logValue) {
            ...
            if (logValue.pointer > 0) {
                console.log(chalk_1.default(templateObject_22 || (templateObject_22 = __makeTemplateObject(["     {yellow [Log]:} at address [", "] [hex: 0x", "] ", ""], ["     {yellow [Log]:} at address [", "] [hex: 0x", "] ", ""])), pointer, hexPointer, logValue.message));
                console.log("");
            }
            else {
