...
(function (factory) {
    ...
    var SummaryTestReporter = /** @class */ (function (_super) {
        ...
        SummaryTestReporter.prototype.onFinish = function (suite) {
            ...
            if (pass === total) {
                console.log(chalk_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.fileName, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
            }
            else {
                console.log(chalk_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.fileName, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
