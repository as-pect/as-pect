...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../util/LogValue", "../util/ActualValue", "./TestGroup", "../util/IPerformanceConfiguration", "./TestResult", "long", "assemblyscript/lib/rtrace"], factory);
    }
    ...
    var rtrace_1 = __importDefault(require("assemblyscript/lib/rtrace"));
    ...
    var TestCollector = /** @class */ (function () {
        ...
        TestCollector.prototype.endRTrace = function (label) {
            var result = this.rtrace.check() - this.rtraceLabels.get(label);
