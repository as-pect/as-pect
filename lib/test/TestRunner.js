...
var TestRunner = /** @class */ (function () {
    ...
    TestRunner.prototype.run = function () {
        ...
        for (var _i = 0, _a = this.suites; _i < _a.length; _i++) {
            var suite = _a[_i];
            var suiteName = this.wasm.getString(suite.describe);
            console.log("");
            console.log(chalk_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Describe {bold ", "}:"], ["Describe {bold ", "}:"])), suiteName));
            ...
            if (beforeAllResult === 0) {
                console.log(chalk_1.default(templateObject_3 || (templateObject_3 = __makeTemplateObject(["  {bgBrightRed.black [Failure]} Test suite ", " failed in beforeAll callback."], ["  {bgBrightRed.black [Failure]} Test suite ", " failed in beforeAll callback."])), this.wasm.getString(suite.describe)));
            ...
            for (var i = 0; i < suite.tests.length; i++) {
                ...
                if (beforeEachResult === 0) {
                    console.log(chalk_1.default(templateObject_5 || (templateObject_5 = __makeTemplateObject(["  {beRedBright.black [Failure]} Test suite ", " failed in beforeEach callback."], ["  {beRedBright.black [Failure]} Test suite ", " failed in beforeEach callback."])), this.wasm.getString(suite.describe)));
                ...
                var testName = this.wasm.getString(suite.testNames[i]);
                var testResult = this.tryCall(suite.tests[i]);
                total += 1;
                if (testResult === 1) {
                    success += 1;
                    console.log(chalk_1.default(templateObject_7 || (templateObject_7 = __makeTemplateObject(["  {bgGreenBright.black [Success]} \u2714 ", ""], ["  {bgGreenBright.black [Success]} \u2714 ", ""])), testName));
                }
                else {
                    failed += 1;
                    this.passed = false;
                ...
                if (afterEachResult === 0) {
                    console.log(chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["  {beRedBright.black [Failure]} Test suite ", " failed in afterEach callback."], ["  {beRedBright.black [Failure]} Test suite ", " failed in afterEach callback."])), suiteName));
            ...
            var afterAllResult = this.tryCall(suite.afterAll);
            if (afterAllResult === 0) {
                console.log(chalk_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["  {beRedBright.black [Failure]} Test suite ", " failed in afterAll callback."], ["  {beRedBright.black [Failure]} Test suite ", " failed in afterAll callback."])), suiteName));
                console.log(chalk_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["    {bgWhite.black [Reason]} ", ""], ["    {bgWhite.black [Reason]} ", ""])), this.reason));
                this.passed = false;
            }
            end = performance.now();
            ...
            console.log("Test Suite: " + (this.passed ? chalk_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\u2714 {bgGreenBright.black PASS}"], ["\u2714 {bgGreenBright.black PASS}"]))) : chalk_1.default(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\u2716 {bgRedBright.white FAIL}"], ["\u2716 {bgRedBright.white FAIL}"])))));
