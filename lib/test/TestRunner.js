...
var TestRunner = /** @class */ (function () {
    ...
    TestRunner.prototype.run = function () {
        ...
        console.log("");
        console.log("");
        console.log("Test Suite: " + (this.passed ? chalk_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["{bgGreenBright.black PASS}"], ["{bgGreenBright.black PASS}"]))) : chalk_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["{bgRedBright.white FAIL}"], ["{bgRedBright.white FAIL}"])))));
