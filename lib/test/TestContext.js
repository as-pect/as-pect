        ...
        TestContext.prototype.runTest = function (runContext, group, testIndex) {
            ...
            if (performanceEnabled) {
                ...
                var maxTestRuntime = !isFinite(maxTestRuntimeValue)
                    ? 5000 /* MaxTestRuntime */
                    : Math.max(maxTestRuntimeValue, 5000 /* MaxTestRuntime */);
                var decimalPlaces = !isFinite(decimalPlacesValue)
                    ? 3
                    : Math.max(10 /* MaximumDecimalPlaces */, Math.min(decimalPlacesValue, 0 /* MinimumDecimalPlaces */));
                ...
                while (true) { // always run at least once
                    ...
                    if (maxTestRuntime !== void 0 && currentTestRunTime >= maxTestRuntime)
