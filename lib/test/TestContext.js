(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./TestGroup", "../util/LogValue", "../util/ActualValue", "./TestResult", "../reporter/DefaultTestReporter", "perf_hooks", "../util/timeDifference", "./RunContext"], factory);
    }
    ...
    var TestContext = /** @class */ (function () {
        ...
        TestContext.prototype.run = function (wasm, reporter, file) {
            ...
            this.wasm = wasm;
            this.file = file;
            var runContext = new RunContext_1.RunContext(wasm, reporter);
        ...
        TestContext.prototype.runTest = function (runContext, group, i) {
            ...
            runContext.teststart = perf_hooks_1.performance.now();
            ...
            for (var _i = 0, _a = group.beforeEachPointers; _i < _a.length; _i++) {
                ...
                if (beforeEachResult === 0) {
                    ...
                    result.pass = false;
                    group.time = timeDifference_1.timeDifference(runContext.groupend, runContext.groupstart);
                    result.time = timeDifference_1.timeDifference(runContext.testend, runContext.teststart);
                    runContext.reporter.onTestFinish(group, result);
                    runContext.reporter.onGroupFinish(group);
            ...
            for (var _b = 0, _c = group.afterEachPointers; _b < _c.length; _b++) {
                var afterEachCallback = _c[_b];
