(function (factory) {
    ...
    var TestContext = /** @class */ (function () {
        ...
        TestContext.prototype.runTest = function (runContext, group, testIndex) {
            ...
            var maxSamples = group.maxSamples[testIndex];
            var minSamples = group.minSamples[testIndex];
            var maxTestRuntime = group.maxTestRuntime[testIndex];
            var minTestRuntime = group.minTestRuntime[testIndex];
