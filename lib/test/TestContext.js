(function (factory) {
    ...
    var TestContext = /** @class */ (function () {
        ...
        TestContext.prototype.testPass = function (timesPointer, performanceEnabled, roundDecimalPlaces, recordAverage, recordMedian, recordMax, recordMin, recordStdDev, recordVariance, negated) {
            var wasm = this.wasm;
            var test = this.currentTest;
