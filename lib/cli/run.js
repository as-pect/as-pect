...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assemblyscript/cli/asc", "../test/TestContext", "fs", "assemblyscript/lib/loader", "../reporter/DefaultTestReporter", "perf_hooks", "../util/timeDifference", "../util/IPerformanceConfiguration", "path", "chalk", "glob", "./util/collectPerformanceConfiguration", "./util/collectReporter", "./util/getTestEntryFiles", "./util/writeFile"], factory);
    }
    ...
    function run(yargs, compilerArgs) {
        ...
        if (outputBinary) {
            console.log(chalk_1.default(templateObject_7 || (templateObject_7 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!runTests) {
            console.log(chalk_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_1.default(templateObject_9 || (templateObject_9 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
        ...
        Array.from(testEntryFiles).forEach(function (file, i) {
            asc_1.default.main([file].concat(Array.from(addedTestEntryFiles), flagList, compilerArgs), {
                ...
                if (count === 0) {
                    if (runTests) {
                        ...
                        var result = failed
                            ? chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
