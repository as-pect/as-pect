...
>>>>>>> a6683906f5239641d8c04614f923c2281cd11849
    ...
    var _a = require("assemblyscript/cli/util/options"), parse = _a.parse, options = _a.options;
...
<<<<<<< HEAD
        var _a = compilerArgs.length > 0 ? parse(compilerArgs, options) : { options: {}, unknown: [] }, ascOptions = _a.options, unknown = _a.unknown;
=======
