...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assemblyscript/cli/asc", "assemblyscript/cli/util/options", "../test/TestContext", "fs", "assemblyscript/lib/loader", "../reporter/DefaultTestReporter", "perf_hooks", "../util/timeDifference", "../util/IPerformanceConfiguration", "path", "chalk", "glob", "./util/collectPerformanceConfiguration", "./util/collectReporter", "./util/getTestEntryFiles", "./util/writeFile"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var asc_1 = __importDefault(require("assemblyscript/cli/asc"));
    var options_1 = require("assemblyscript/cli/util/options");
    ...
    function run(yargs, compilerArgs) {
        ...
        var _a = compilerArgs.length > 0 ? options_1.parse(compilerArgs, asc_1.default.options) : { options: {}, unknown: [] }, ascOptions = _a.options, unknown = _a.unknown;
        if (unknown.length > 0) {
            console.log(chalk_1.default(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        if (!runTests) {
            console.log(chalk_1.default(templateObject_9 || (templateObject_9 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
            ...
            asc_1.default.main([file].concat(Array.from(addedTestEntryFiles), flagList), {
                ...
                if (count === 0) {
                    if (runTests) {
                        ...
                        var result = failed
                            ? chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
