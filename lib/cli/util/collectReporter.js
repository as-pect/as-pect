        ...
        if (targetReporter.startsWith(".")) {
            try {
                ...
                if (reporterResult) {
                    ...
                    return new DefaultTestReporter_1.default(options);
                }
            }
            catch (ex) {
            ...
            try {
                var Reporter = require(path_1.default.join(__dirname, "..", "..", "reporter", targetReporter));
                return new Reporter.default(options);
            }
            catch (ex) {
