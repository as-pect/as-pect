...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "chalk", "path", "glob", "yargs-parser", "assemblyscript/cli/asc", "./test/TestContext", "fs", "assemblyscript/lib/loader", "./reporter/DefaultTestReporter", "perf_hooks", "./util/timeDifference", "./util/IPerformanceConfiguration"], factory);
    }
    ...
    function asp(args) {
        ...
        if (yargs.argv.t || yargs.argv.types) {
            ...
            if (performanceConfiguration_1.enabled) {
                console.log(chalk_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["{bgWhite.black [Log]} Performance has been enabled on this test suite."], ["{bgWhite.black [Log]} Performance has been enabled on this test suite."]))));
            ...
            console.log(chalk_1.default(templateObject_17 || (templateObject_17 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                ...
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (count_1 === 0) {
                        ...
                        var result = failed
                            ? chalk_1.default(templateObject_18 || (templateObject_18 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_1.default(templateObject_19 || (templateObject_19 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
