...
console.log(chalk_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{bold.bgWhite.black ", "     ___   _____                       __  \n    /   | / ___/      ____  ___  _____/ /_ \n   / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/ \n  / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n /_/  |_/____/     / .___/\\___/\\___/\\__/   \n                  /_/                      } AS-pect Test suite runner {bgGreenBright.black [", "]}\n"], ["{bold.bgWhite.black ",
    "     ___   _____                       __  \n    /   | / ___/      ____  ___  _____/ /_ \n   / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/ \n  / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/   \n                  /_/                      } AS-pect Test suite runner {bgGreenBright.black [", "]}\n"])), "", pkg.version));
if (yargs_1.default.argv.i || yargs_1.default.argv.init) {
    console.log("");
    console.log(chalk_1.default(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{bgWhite.black [Log]} Initializing test suite files."], ["{bgWhite.black [Log]} Initializing test suite files."]))));
    console.log("");
...
else if (yargs_1.default.argv.c || yargs_1.default.argv.config) {
    var configurationPath = path_1.default.resolve(process.cwd(), yargs_1.default.argv.c || yargs_1.default.argv.config);
    ...
    console.log(chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["{bgWhite.black [Log]} including files ", ""], ["{bgWhite.black [Log]} including files ", ""])), configuration_1.include.join(", ")));
    console.log("");
    console.log("");
    var files_1 = [];
    ...
    files_1.forEach(function (file, i) {
        console.log(chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["{bgWhite.black [Log]} Compiling: ", " ", " / ", ""], ["{bgWhite.black [Log]} Compiling: ", " ", " / ", ""])), file, (i + 1).toString(), files_1.length.toString()));
        console.log("");
        asc_1.default.main([
            file, relativePath_1,
            "--validate",
            ...
            var runner = new TestRunner_1.TestRunner(binaries_1[i], Object.assign({}, configuration_1.imports));
            runner.run();
            count_1 -= 1;
            failed_1 = failed_1 || !runner.passed;
    ...
    console.log("");
    console.log(chalk_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["asp --help"], ["asp --help"]))));
    console.log("");
    console.log(chalk_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["  {bold --config, -c <configuration>}"], ["  {bold --config, -c <configuration>}"]))));
    console.log(chalk_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["    If a configuration is supplied, the command will run the test suite."], ["    If a configuration is supplied, the command will run the test suite."]))));
    console.log(chalk_1.default(templateObject_17 || (templateObject_17 = __makeTemplateObject(["  {bold --init, -i}"], ["  {bold --init, -i}"]))));
    console.log(chalk_1.default(templateObject_18 || (templateObject_18 = __makeTemplateObject(["    The init option will initialize a test suite."], ["    The init option will initialize a test suite."]))));
}
