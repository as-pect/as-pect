            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                ...
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (count_1 === 0) {
                        ...
                        var result = failed
                            ? chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
