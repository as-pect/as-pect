        ...
        if (yargs.argv.i || yargs.argv.init) {
            ...
            if (performanceConfiguration_1.enabled) {
                ...
                if (yargs.argv.hasOwnProperty("minSamples"))
                    performanceConfiguration_1.minSamples = parseFloat(yargs.argv.minSamples.toString());
                ...
                if (yargs.argv.hasOwnProperty("minTestRunTime"))
                    performanceConfiguration_1.minTestRunTime = parseFloat(yargs.argv.minTestRunTime.toString());
