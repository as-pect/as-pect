...
(function (factory) {
    ...
    function asp(args) {
        ...
        if (yargs.argv.i || yargs.argv.init) {
            ...
            reporter_1.onLog(null, chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["including files ", ""], ["including files ", ""])), configuration_1.include.join(", ")));
            var files_1 = [];
            // for each pattern
            ...
            files_1.forEach(function (file, i) {
                reporter_1.onLog(null, chalk_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Compiling: ", " ", " / ", ""], ["Compiling: ", " ", " / ", ""])), file, (i + 1).toString(), files_1.length.toString()));
                ...
                asc_1.default.main([
                    ...
                    if (error) {
                        reporter_1.onLog(null, chalk_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["There was a compilation error when trying to create the wasm binary for file: ", "."], ["There was a compilation error when trying to create the wasm binary for file: ", "."])), file));
                        console.error(error);
                        process.exit(1);
                        return;
                    }
                    ...
                    if (!binaries_1[i]) {
                        reporter_1.onLog(null, chalk_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["There was no output binary file: ", ". Did you forget to emit the binary?"], ["There was no output binary file: ", ". Did you forget to emit the binary?"])), file));
                        process.exit(1);
                        return;
                    }
