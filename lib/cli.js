            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (runner.errors.length > 0) {
                        errors_1.push.apply(errors_1, runner.errors);
                    }
                    else {
                    ...
                    if (count_1 === 0) {
                        ...
                        var failed = testCount_1 !== successCount_1 || errors_1.length > 0;
                        var result = failed
                        ...
                        for (var _i = 0, errors_2 = errors_1; _i < errors_2.length; _i++) {
                            var error_1 = errors_2[_i];
                            console.log(chalk_1.default(templateObject_19 || (templateObject_19 = __makeTemplateObject(["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n"], ["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n"])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                        }
