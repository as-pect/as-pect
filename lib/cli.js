...
yargs_1.default.help(false);
if (!(yargs_1.default.argv.v || yargs_1.default.argv.version)) {
...
if (yargs_1.default.argv.i || yargs_1.default.argv.init) {
    ...
    console.log(chalk_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["[Log] including files ", ""], ["[Log] including files ", ""])), configuration_1.include.join(", ")));
    console.log("");
    console.log("");
    var files_1 = [];
    ...
    files_1.forEach(function (file, i) {
        console.log(chalk_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["[Log] Compiling: ", " ", " / ", ""], ["[Log] Compiling: ", " ", " / ", ""])), file, (i + 1).toString(), files_1.length.toString()));
        console.log("");
        asc_1.default.main([
            file, relativePath_1,
            "--validate",
            ...
            if (error) {
                console.log(chalk_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."], ["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."])), file));
                console.log(error);
                process.exit(1);
                return;
            }
            if (!binaries_1[i]) {
                console.log(chalk_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["{red [Error]} There was no output binary file: ", "."], ["{red [Error]} There was no output binary file: ", "."])), file));
                process.exit(1);
                return;
            }
