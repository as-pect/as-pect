    ...
    function asp(args) {
        ...
        if (yargs.argv.i || yargs.argv.init) {
            ...
            try {
                ...
                console.log("");
                console.log(chalk_2.default(templateObject_26 || (templateObject_26 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
                console.log(ex);
                process.exit(1);
            }
            if (!(typeof configuration_1 === "object")) {
                console.log("");
                console.log(chalk_2.default(templateObject_27 || (templateObject_27 = __makeTemplateObject(["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."])), configurationPath));
                process.exit(1);
            }
            console.log(chalk_2.default(templateObject_28 || (templateObject_28 = __makeTemplateObject(["[Log] including files ", ""], ["[Log] including files ", ""])), configuration_1.include.join(", ")));
            console.log("");
            console.log("");
            var files_1 = [];
            ...
            files_1.forEach(function (file, i) {
                console.log(chalk_2.default(templateObject_29 || (templateObject_29 = __makeTemplateObject(["[Log] Compiling: ", " ", " / ", ""], ["[Log] Compiling: ", " ", " / ", ""])), file, (i + 1).toString(), files_1.length.toString()));
                console.log("");
                asc_1.default.main([
                    file, relativePath_1,
                    "--validate",
                    ...
                    if (error) {
                        console.log(chalk_2.default(templateObject_30 || (templateObject_30 = __makeTemplateObject(["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."], ["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."])), file));
                        console.log(error);
                        process.exit(1);
                        return;
                    }
                    if (!binaries_1[i]) {
                        console.log(chalk_2.default(templateObject_31 || (templateObject_31 = __makeTemplateObject(["{red [Error]} There was no output binary file: ", "."], ["{red [Error]} There was no output binary file: ", "."])), file));
                        process.exit(1);
                        return;
                    }
