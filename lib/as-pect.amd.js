...
define("test/TestCollector", ["require", "exports", "util/LogValue", "util/ActualValue", "test/TestGroup", "util/IPerformanceConfiguration", "test/TestResult"], function (require, exports, LogValue_2, ActualValue_1, TestGroup_1, IPerformanceConfiguration_1, TestResult_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("reporter/SummaryTestReporter", ["require", "exports", "test/TestReporter", "chalk"], function (require, exports, TestReporter_3, chalk_2) {
    ...
    var SummaryTestReporter = /** @class */ (function (_super) {
        ...
        SummaryTestReporter.prototype.onFinish = function (suite) {
            ...
            if (pass === total) {
                console.log(chalk_2.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.fileName, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
            }
            else {
                console.log(chalk_2.default(templateObject_34 || (templateObject_34 = __makeTemplateObject(["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.fileName, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
                for (var _i = 0, _c = suite.testGroups; _i < _c.length; _i++) {
                    var group = _c[_i];
                    if (group.pass)
                        continue;
                    console.log(chalk_2.default(templateObject_35 || (templateObject_35 = __makeTemplateObject(["  ", ""], ["  ", ""])), group.name));
                    inner: for (var _d = 0, _e = group.tests; _d < _e.length; _d++) {
                        var test_1 = _e[_d];
                        if (test_1.pass)
                            continue inner;
                        console.log(chalk_2.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["    {red.bold \u274C ", "} - ", ""], ["    {red.bold \u274C ", "} - ", ""])), test_1.name, test_1.message));
                        if (test_1.expected !== null)
                            console.log(chalk_2.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["      {green.bold [Expected]:} ", ""], ["      {green.bold [Expected]:} ", ""])), test_1.expected.message));
                        if (test_1.actual !== null)
                            console.log(chalk_2.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["      {red.bold [Actual]  :} ", ""], ["      {red.bold [Actual]  :} ", ""])), test_1.actual.message));
                    }
                }
            }
        };
    ...
    var templateObject_33, templateObject_34, templateObject_35, templateObject_36, templateObject_37, templateObject_38;
});
define("util/IConfiguration", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("cli/types", ["require", "exports", "chalk", "fs"], function (require, exports, chalk_3, fs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.types = types;
    var templateObject_39, templateObject_40, templateObject_41, templateObject_42;
});
define("cli/init", ["require", "exports", "chalk", "path", "fs"], function (require, exports, chalk_4, path_1, fs_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function init(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_4.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
        console.log("");
        // create the assembly folder if it doesn't exist
        if (!fs_2.default.existsSync(assemblyFolder)) {
            console.log(chalk_4.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_2.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_2.default.existsSync(testFolder)) {
            console.log(chalk_4.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            ...
            if (!fs_2.default.existsSync(exampleFile)) {
                console.log(chalk_4.default(templateObject_46 || (templateObject_46 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
                fs_2.default.createReadStream(exampleFileSource, "utf-8")
                    .pipe(fs_2.default.createWriteStream(exampleFile, "utf-8"));
            }
        }
        // create the types file if it doesn't exist for typescript tooling users
        if (!fs_2.default.existsSync(typesFile)) {
            console.log(chalk_4.default(templateObject_47 || (templateObject_47 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
        ...
        if (!fs_2.default.existsSync(configFile)) {
            console.log(chalk_4.default(templateObject_48 || (templateObject_48 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            fs_2.default.createReadStream(configFileSource, "utf-8")
                .pipe(fs_2.default.createWriteStream(configFile, "utf-8"));
        }
    }
    exports.init = init;
    var templateObject_43, templateObject_44, templateObject_45, templateObject_46, templateObject_47, templateObject_48;
});
...
define("cli/util/collectReporter", ["require", "exports", "reporter/DefaultTestReporter", "reporter/EmptyReporter", "reporter/SummaryTestReporter", "path"], function (require, exports, DefaultTestReporter_2, EmptyReporter_1, SummaryTestReporter_1, path_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function collectReporter(yargs) {
        ...
        if (targetReporter.startsWith(".")) {
            try {
                var result = require(path_2.default.join(process.cwd(), targetReporter));
                ...
                console.error("Cannot find target reporter at", path_2.default.join(process.cwd(), targetReporter));
                console.error(ex);
                process.exit(1);
...
define("cli/util/writeFile", ["require", "exports", "fs"], function (require, exports, fs_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("cli/run", ["require", "exports", "assemblyscript/cli/asc", "assemblyscript/cli/util/options", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, asc_1, options_1, TestContext_1, fs, loader_1, DefaultTestReporter_3, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, path, chalk_6, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function run(yargs, compilerArgs) {
        ...
        console.log(chalk_6.default(templateObject_50 || (templateObject_50 = __makeTemplateObject(["{bgWhite.black [Log]} Using configuration ", ""], ["{bgWhite.black [Log]} Using configuration ", ""])), configurationPath));
        var configuration = {};
        try {
            ...
            console.error("");
            console.error(chalk_6.default(templateObject_51 || (templateObject_51 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.error(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.error(chalk_6.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.error(chalk_6.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        console.log(chalk_6.default(templateObject_54 || (templateObject_54 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        ...
        if (!configuration.testRegex) {
            ...
            console.log(chalk_6.default(templateObject_55 || (templateObject_55 = __makeTemplateObject(["{bgWhite.black [Log]} Running tests that match: ", ""], ["{bgWhite.black [Log]} Running tests that match: ", ""])), testRegex.source));
        }
        if (!configuration.groupRegex) {
            ...
            console.log(chalk_6.default(templateObject_56 || (templateObject_56 = __makeTemplateObject(["{bgWhite.black [Log]} Running groups that match: ", ""], ["{bgWhite.black [Log]} Running groups that match: ", ""])), groupRegex.source));
        }
        /**
        ...
        if (outputBinary) {
            console.log(chalk_6.default(templateObject_57 || (templateObject_57 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!runTests) {
            console.log(chalk_6.default(templateObject_58 || (templateObject_58 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_6.default(templateObject_59 || (templateObject_59 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
            ...
            asc_1.default.main([file].concat(Array.from(addedTestEntryFiles), flagList), {
                ...
                if (count === 0) {
                    if (runTests) {
                        ...
                        var result = failed
                            ? chalk_6.default(templateObject_60 || (templateObject_60 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_6.default(templateObject_61 || (templateObject_61 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
                        for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                            var error_1 = errors_1[_i];
                            console.log(chalk_6.default(templateObject_62 || (templateObject_62 = __makeTemplateObject(["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "], ["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                        }
    ...
    exports.run = run;
    var templateObject_50, templateObject_51, templateObject_52, templateObject_53, templateObject_54, templateObject_55, templateObject_56, templateObject_57, templateObject_58, templateObject_59, templateObject_60, templateObject_61, templateObject_62;
});
define("cli/index", ["require", "exports", "chalk", "path", "yargs-parser", "cli/types", "cli/init", "cli/help", "cli/run"], function (require, exports, chalk_7, path_3, yargs_parser_1, types_1, init_1, help_1, run_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function asp(args) {
        ...
        if (!(yargs.argv.v || yargs.argv.version)) {
            console.log(chalk_7.default(templateObject_63 || (templateObject_63 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\___/\\___/\\__/     \n                    /_/                        }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "], ["{bold.bgWhite.black ",
                "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/     \n                    /_/                        }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "])), "", pkg.version));
        }
...
define("as-pect", ["require", "exports", "test/TestContext", "test/TestGroup", "test/TestReporter", "test/TestResult", "reporter/DefaultTestReporter", "reporter/EmptyReporter", "reporter/SummaryTestReporter", "util/ActualValue", "util/IPerformanceConfiguration", "util/LogValue", "cli/index"], function (require, exports, TestContext_2, TestGroup_2, TestReporter_4, TestResult_2, DefaultTestReporter_4, EmptyReporter_2, SummaryTestReporter_2, ActualValue_2, IPerformanceConfiguration_3, LogValue_3, cli_1) {
    "use strict";
    function __export(m) {
...
define("reporter/CSVTestReporter", ["require", "exports", "test/TestReporter", "csv-stringify", "fs", "path"], function (require, exports, TestReporter_5, csv_stringify_1, fs_4, path_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CSVTestReporter = /** @class */ (function (_super) {
        ...
        CSVTestReporter.prototype.onStart = function (suite) {
            ...
            var extension = path_4.extname(suite.fileName);
            var dir = path_4.dirname(suite.fileName);
            var base = path_4.basename(suite.fileName, extension);
            var outPath = path_4.join(process.cwd(), dir, base + ".csv");
            this.fileName = fs_4.createWriteStream(outPath, "utf8");
...
define("reporter/JSONTestReporter", ["require", "exports", "test/TestReporter", "fs", "path"], function (require, exports, TestReporter_6, fs_5, path_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var JSONTestReporter = /** @class */ (function (_super) {
        ...
        JSONTestReporter.prototype.onStart = function (suite) {
            var extension = path_5.extname(suite.fileName);
            var dir = path_5.dirname(suite.fileName);
            var base = path_5.basename(suite.fileName, extension);
            var outPath = path_5.join(process.cwd(), dir, base + ".json");
            this.file = fs_5.createWriteStream(outPath, "utf8");
            this.file.write("[");
            this.first = true;
        };
