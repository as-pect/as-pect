...
define("reporter/SummaryTestReporter", ["require", "exports", "test/TestReporter", "chalk"], function (require, exports, TestReporter_3, chalk_2) {
    ...
    var SummaryTestReporter = /** @class */ (function (_super) {
        ...
        SummaryTestReporter.prototype.onFinish = function (suite) {
            ...
            if (pass === total) {
                console.log(chalk_2.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{green.bold \u2714 ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.file, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
            }
            else {
                console.log(chalk_2.default(templateObject_34 || (templateObject_34 = __makeTemplateObject(["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"], ["{red.bold \u274C ", "} Pass: ", " / ", " Todo: ", " Time: ", "ms"])), suite.file, pass.toString(), total.toString(), todos.toString(), suite.time.toString()));
...
define("cli", ["require", "exports", "chalk", "path", "glob", "yargs-parser", "assemblyscript/cli/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "reporter/EmptyReporter", "reporter/SummaryTestReporter"], function (require, exports, chalk_3, path_1, glob_1, yargs_parser_1, asc_1, TestContext_1, fs_1, loader_1, DefaultTestReporter_2, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, EmptyReporter_1, SummaryTestReporter_1) {
    ...
    function asp(args) {
        ...
        if (!(yargs.argv.v || yargs.argv.version)) {
            console.log(chalk_3.default(templateObject_39 || (templateObject_39 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\___/\\___/\\__/   \n                    /_/                      }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "], ["{bold.bgWhite.black ",
                "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/   \n                    /_/                      }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "])), "", pkg.version));
        }
        ...
        if (yargs.argv.t || yargs.argv.types) {
            console.log("");
            console.log(chalk_3.default(templateObject_40 || (templateObject_40 = __makeTemplateObject(["[Log] Initializing types."], ["[Log] Initializing types."]))));
            console.log("");
            // Create the assembly folder if it doesn't exist
            if (!fs_1.default.existsSync(assemblyFolder)) {
                console.log(chalk_3.default(templateObject_41 || (templateObject_41 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
                fs_1.default.mkdirSync(assemblyFolder);
            }
            // Create the test folder if it doesn't exist
            if (!fs_1.default.existsSync(testFolder)) {
                console.log(chalk_3.default(templateObject_42 || (templateObject_42 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
                fs_1.default.mkdirSync(testFolder);
            }
            // Create the types file if it doesn't exist
            if (!fs_1.default.existsSync(typesFile)) {
                console.log(chalk_3.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            ...
            // init script
            console.log("");
            console.log(chalk_3.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
            console.log("");
            // create the assembly folder if it doesn't exist
            if (!fs_1.default.existsSync(assemblyFolder)) {
                console.log(chalk_3.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
                fs_1.default.mkdirSync(assemblyFolder);
            }
            // Create the test folder if it doesn't exist
            if (!fs_1.default.existsSync(testFolder)) {
                console.log(chalk_3.default(templateObject_46 || (templateObject_46 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
                fs_1.default.mkdirSync(testFolder);
                ...
                if (!fs_1.default.existsSync(exampleFile)) {
                    console.log(chalk_3.default(templateObject_47 || (templateObject_47 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
            ...
            if (!fs_1.default.existsSync(typesFile)) {
                console.log(chalk_3.default(templateObject_48 || (templateObject_48 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
                fs_1.default.createReadStream(typesFileSource, "utf-8")
                    .pipe(fs_1.default.createWriteStream(typesFile, "utf-8"));
            }
            ...
            if (!fs_1.default.existsSync(configFile)) {
                console.log(chalk_3.default(templateObject_49 || (templateObject_49 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            ...
            console.log(chalk_3.default(templateObject_51 || (templateObject_51 = __makeTemplateObject(["{bgWhite.black [Log]} using configuration ", ""], ["{bgWhite.black [Log]} using configuration ", ""])), configurationPath));
            var configuration_1 = {};
            try {
                ...
                console.log("");
                console.log(chalk_3.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
                console.log(ex);
                process.exit(1);
            }
            // configuration must be an object
            if (!configuration_1) {
                console.log(chalk_3.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."])), configurationPath));
                process.exit(1);
            }
            ...
            console.log(chalk_3.default(templateObject_54 || (templateObject_54 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (count_1 === 0) {
                        ...
                        var result = failed
                            ? chalk_3.default(templateObject_55 || (templateObject_55 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_3.default(templateObject_56 || (templateObject_56 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
    ...
    exports.asp = asp;
    var templateObject_39, templateObject_40, templateObject_41, templateObject_42, templateObject_43, templateObject_44, templateObject_45, templateObject_46, templateObject_47, templateObject_48, templateObject_49, templateObject_50, templateObject_51, templateObject_52, templateObject_53, templateObject_54, templateObject_55, templateObject_56;
});
define("as-pect", ["require", "exports", "test/TestContext", "test/TestGroup", "test/TestReporter", "test/TestResult", "reporter/DefaultTestReporter", "reporter/EmptyReporter", "reporter/SummaryTestReporter", "util/ActualValue", "util/IPerformanceConfiguration", "util/LogValue", "cli"], function (require, exports, TestContext_2, TestGroup_2, TestReporter_4, TestResult_2, DefaultTestReporter_3, EmptyReporter_2, SummaryTestReporter_2, ActualValue_2, IPerformanceConfiguration_3, LogValue_3, cli_1) {
    "use strict";
    function __export(m) {
...
define("cli/types", ["require", "exports", "chalk", "fs"], function (require, exports, chalk_5, fs_2) {
    ...
    function types(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_5.default(templateObject_58 || (templateObject_58 = __makeTemplateObject(["[Log] Initializing types."], ["[Log] Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_2.default.existsSync(assemblyFolder)) {
            console.log(chalk_5.default(templateObject_59 || (templateObject_59 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_2.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_2.default.existsSync(testFolder)) {
            console.log(chalk_5.default(templateObject_60 || (templateObject_60 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            fs_2.default.mkdirSync(testFolder);
        }
        // Create the types file if it doesn't exist
        if (!fs_2.default.existsSync(typesFile)) {
            console.log(chalk_5.default(templateObject_61 || (templateObject_61 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            fs_2.default.createReadStream(typesFileSource, "utf-8")
                .pipe(fs_2.default.createWriteStream(typesFile, "utf-8"));
        }
    }
    exports.types = types;
    var templateObject_58, templateObject_59, templateObject_60, templateObject_61;
});
define("cli/init", ["require", "exports", "chalk", "path", "fs"], function (require, exports, chalk_6, path_2, fs_3) {
    ...
    function init(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_6.default(templateObject_62 || (templateObject_62 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
        console.log("");
        // create the assembly folder if it doesn't exist
        if (!fs_3.default.existsSync(assemblyFolder)) {
            console.log(chalk_6.default(templateObject_63 || (templateObject_63 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_3.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_3.default.existsSync(testFolder)) {
            console.log(chalk_6.default(templateObject_64 || (templateObject_64 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            ...
            if (!fs_3.default.existsSync(exampleFile)) {
                console.log(chalk_6.default(templateObject_65 || (templateObject_65 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
        ...
        if (!fs_3.default.existsSync(typesFile)) {
            console.log(chalk_6.default(templateObject_66 || (templateObject_66 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
        ...
        if (!fs_3.default.existsSync(configFile)) {
            console.log(chalk_6.default(templateObject_67 || (templateObject_67 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            fs_3.default.createReadStream(configFileSource, "utf-8")
                .pipe(fs_3.default.createWriteStream(configFile, "utf-8"));
        }
    }
    exports.init = init;
    var templateObject_62, templateObject_63, templateObject_64, templateObject_65, templateObject_66, templateObject_67;
});
...
define("cli/run", ["require", "exports", "assemblyscript/cli/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles"], function (require, exports, asc_2, TestContext_3, fs, loader_2, DefaultTestReporter_5, perf_hooks_3, timeDifference_3, IPerformanceConfiguration_4, path, chalk_7, glob_3, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1) {
    ...
    function run(yargs) {
        ...
        try {
            ...
            console.log("");
            console.log(chalk_7.default(templateObject_69 || (templateObject_69 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.log(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.log(chalk_7.default(templateObject_70 || (templateObject_70 = __makeTemplateObject(["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        var performanceConfiguration = configuration.performance || IPerformanceConfiguration_4.createDefaultPerformanceConfiguration();
        // setup performance options, overriding configured values if the flag is passed to the cli
        collectPerformanceConfiguration_1.collectPerformanceConfiguration(yargs, performanceConfiguration);
        // include all the file globs
        console.log(chalk_7.default(templateObject_71 || (templateObject_71 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        // add a line seperator between the next line and this line
        console.log("");
        ...
        Array.from(testEntryFiles).forEach(function (file, i) {
            asc_2.default.main([file].concat(Array.from(addedTestEntryFiles), flagList), {
                ...
                if (count === 0) {
                    ...
                    var result = failed
                        ? chalk_7.default(templateObject_72 || (templateObject_72 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_7.default(templateObject_73 || (templateObject_73 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                    console.log("~".repeat(process.stdout.columns - 10));
                    for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                        var error_1 = errors_1[_i];
                        console.log(chalk_7.default(templateObject_74 || (templateObject_74 = __makeTemplateObject(["\n [Error]: {red ", "}: ", "\n [Stack]: {yellow ", "}\n"], ["\n [Error]: {red ", "}: ", "\n [Stack]: {yellow ", "}\n"])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                    }
    ...
    exports.run = run;
    var templateObject_68, templateObject_69, templateObject_70, templateObject_71, templateObject_72, templateObject_73, templateObject_74;
});
define("cli/index", ["require", "exports", "chalk", "path", "yargs-parser", "cli/types", "cli/init", "cli/help", "cli/run"], function (require, exports, chalk_8, path_4, yargs_parser_2, types_1, init_1, help_1, run_1) {
    ...
    function asp(args) {
        ...
        // Skip ascii art if asked for the version
        if (!(yargs.argv.v || yargs.argv.version)) {
            console.log(chalk_8.default(templateObject_75 || (templateObject_75 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\___/\\___/\\__/   \n                    /_/                      }\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "], ["{bold.bgWhite.black ",
                "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/   \n                    /_/                      }\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "])), "", pkg.version));
        }
