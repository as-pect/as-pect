...
define("reporter/SummaryTestReporter", ["require", "exports", "test/TestReporter", "chalk"], function (require, exports, TestReporter_5, chalk_2) {
            ...
            if (pass === total) {
                ...
                for (var _i = 0, _c = suite.testGroups; _i < _c.length; _i++) {
                    ...
                    inner: for (var _d = 0, _e = group.tests; _d < _e.length; _d++) {
                        ...
                        if (test_1.pass)
                            continue inner;
                        suite.stdout.write(chalk_2.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["    {red.bold \u274C ", "} - ", "\n"], ["    {red.bold \u274C ", "} - ", "\\n"])), test_1.name, test_1.message));
                        if (test_1.expected !== null)
                            suite.stdout.write(chalk_2.default(templateObject_34 || (templateObject_34 = __makeTemplateObject(["      {green.bold [Expected]:} ", "\n"], ["      {green.bold [Expected]:} ", "\\n"])), test_1.expected.message));
                        if (test_1.actual !== null)
                            suite.stdout.write(chalk_2.default(templateObject_35 || (templateObject_35 = __makeTemplateObject(["      {red.bold [Actual]  :} ", "\n"], ["      {red.bold [Actual]  :} ", "\\n"])), test_1.actual.message));
                    }
                }
            }
        };
    ...
    var templateObject_30, templateObject_31, templateObject_32, templateObject_33, templateObject_34, templateObject_35;
});
...
define("cli/types", ["require", "exports", "chalk", "fs"], function (require, exports, chalk_3, fs_3) {
    ...
    function types(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_3.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["[Log] Initializing types."], ["[Log] Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_3.default.existsSync(assemblyFolder)) {
            console.log(chalk_3.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_3.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_3.default.existsSync(testFolder)) {
            console.log(chalk_3.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            fs_3.default.mkdirSync(testFolder);
        }
        // Create the types file if it doesn't exist
        if (!fs_3.default.existsSync(typesFile)) {
            console.log(chalk_3.default(templateObject_39 || (templateObject_39 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            fs_3.default.createReadStream(typesFileSource, "utf-8")
                .pipe(fs_3.default.createWriteStream(typesFile, "utf-8"));
        }
    }
    exports.types = types;
    var templateObject_36, templateObject_37, templateObject_38, templateObject_39;
});
define("cli/init", ["require", "exports", "chalk", "path", "fs"], function (require, exports, chalk_4, path_3, fs_4) {
    ...
    function init(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_4.default(templateObject_40 || (templateObject_40 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
        console.log("");
        // create the assembly folder if it doesn't exist
        if (!fs_4.default.existsSync(assemblyFolder)) {
            console.log(chalk_4.default(templateObject_41 || (templateObject_41 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_4.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_4.default.existsSync(testFolder)) {
            console.log(chalk_4.default(templateObject_42 || (templateObject_42 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            ...
            if (!fs_4.default.existsSync(exampleFile)) {
                console.log(chalk_4.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
        ...
        if (!fs_4.default.existsSync(typesFile)) {
            console.log(chalk_4.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
        ...
        if (!fs_4.default.existsSync(configFile)) {
            console.log(chalk_4.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            fs_4.default.createReadStream(configFileSource, "utf-8")
                .pipe(fs_4.default.createWriteStream(configFile, "utf-8"));
        }
    }
    exports.init = init;
    var templateObject_40, templateObject_41, templateObject_42, templateObject_43, templateObject_44, templateObject_45;
});
...
define("cli/run", ["require", "exports", "assemblyscript/dist/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, asc_1, TestContext_1, fs, loader_1, DefaultTestReporter_3, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, path, chalk_6, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    ...
    function run(yargs, compilerArgs) {
        ...
        console.log(chalk_6.default(templateObject_47 || (templateObject_47 = __makeTemplateObject(["{bgWhite.black [Log]} Using configuration ", ""], ["{bgWhite.black [Log]} Using configuration ", ""])), configurationPath));
        var configuration = {};
        try {
            ...
            console.error("");
            console.error(chalk_6.default(templateObject_48 || (templateObject_48 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.error(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.error(chalk_6.default(templateObject_49 || (templateObject_49 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.error(chalk_6.default(templateObject_50 || (templateObject_50 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        console.log(chalk_6.default(templateObject_51 || (templateObject_51 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        ...
        if (!configuration.testRegex) {
            ...
            console.log(chalk_6.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgWhite.black [Log]} Running tests that match: ", ""], ["{bgWhite.black [Log]} Running tests that match: ", ""])), testRegex.source));
        }
        if (!configuration.groupRegex) {
            ...
            console.log(chalk_6.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bgWhite.black [Log]} Running groups that match: ", ""], ["{bgWhite.black [Log]} Running groups that match: ", ""])), groupRegex.source));
        }
        /**
        ...
        if (outputBinary) {
            console.log(chalk_6.default(templateObject_54 || (templateObject_54 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!configuration.nortrace) {
            console.log(chalk_6.default(templateObject_55 || (templateObject_55 = __makeTemplateObject(["{bgWhite.black [Log]} Reference Tracing is enabled."], ["{bgWhite.black [Log]} Reference Tracing is enabled."]))));
            if (flags["--use"]) {
        ...
        if (!runTests) {
            console.log(chalk_6.default(templateObject_56 || (templateObject_56 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_6.default(templateObject_57 || (templateObject_57 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
        ...
        var fileMap = new Map();
        console.log(chalk_6.default(templateObject_58 || (templateObject_58 = __makeTemplateObject(["{bgWhite.black [Log]} Effective command line arguments:"], ["{bgWhite.black [Log]} Effective command line arguments:"]))));
        console.log(chalk_6.default(templateObject_59 || (templateObject_59 = __makeTemplateObject(["  ", ""], ["  ", ""])), flagList.join(" ")));
    ...
    exports.run = run;
    var templateObject_47, templateObject_48, templateObject_49, templateObject_50, templateObject_51, templateObject_52, templateObject_53, templateObject_54, templateObject_55, templateObject_56, templateObject_57, templateObject_58, templateObject_59, templateObject_60, templateObject_61, templateObject_62;
});
