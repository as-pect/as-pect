...
define("test/TestContext", ["require", "exports", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "test/TestCollector"], function (require, exports, DefaultTestReporter_1, perf_hooks_1, timeDifference_1, TestCollector_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    DefaultTestReporter_1 = __importDefault(DefaultTestReporter_1);
...
define("cli/util/collectReporter", ["require", "exports", "reporter/DefaultTestReporter", "path", "querystring", "chalk"], function (require, exports, DefaultTestReporter_3, path_5, querystring_1, chalk_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    DefaultTestReporter_3 = __importDefault(DefaultTestReporter_3);
        ...
        if (targetReporter.startsWith(".")) {
            try {
                ...
                if (reporterResult) {
                    ...
                    return new DefaultTestReporter_3.default(options);
                }
            }
            catch (ex) {
            ...
            try {
                var Reporter = require(path_5.default.join(__dirname, "..", "..", "reporter", targetReporter));
...
define("cli/run", ["require", "exports", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, TestContext_2, fs, loader_1, DefaultTestReporter_4, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_3, path, chalk_7, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    fs = __importStar(fs);
    DefaultTestReporter_4 = __importDefault(DefaultTestReporter_4);
    ...
    function run(yargs, compilerArgs) {
        ...
        console.log(chalk_7.default(templateObject_61 || (templateObject_61 = __makeTemplateObject(["{bgWhite.black [Log]} Compiler loaded in ", "ms"], ["{bgWhite.black [Log]} Compiler loaded in ", "ms"])), timeDifference_2.timeDifference(perf_hooks_2.performance.now(), start).toString()));
        // obtain the configuration file
        var configurationPath = path.resolve(process.cwd(), yargs.argv.c || yargs.argv.config || "./as-pect.config.js");
        console.log(chalk_7.default(templateObject_62 || (templateObject_62 = __makeTemplateObject(["{bgWhite.black [Log]} Using configuration ", ""], ["{bgWhite.black [Log]} Using configuration ", ""])), configurationPath));
        var configuration = {};
        try {
            ...
            console.error("");
            console.error(chalk_7.default(templateObject_63 || (templateObject_63 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.error(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.error(chalk_7.default(templateObject_64 || (templateObject_64 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.error(chalk_7.default(templateObject_65 || (templateObject_65 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        var reporter = (yargs.argv.reporter || yargs.argv.r)
            ...
            : configuration.reporter || new DefaultTestReporter_4.default({});
        ...
        console.log(chalk_7.default(templateObject_66 || (templateObject_66 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        ...
        if (!configuration.testRegex) {
            ...
            console.log(chalk_7.default(templateObject_67 || (templateObject_67 = __makeTemplateObject(["{bgWhite.black [Log]} Running tests that match: ", ""], ["{bgWhite.black [Log]} Running tests that match: ", ""])), testRegex.source));
        }
        if (!configuration.groupRegex) {
            ...
            console.log(chalk_7.default(templateObject_68 || (templateObject_68 = __makeTemplateObject(["{bgWhite.black [Log]} Running groups that match: ", ""], ["{bgWhite.black [Log]} Running groups that match: ", ""])), groupRegex.source));
        }
        /**
        ...
        if (outputBinary) {
            console.log(chalk_7.default(templateObject_69 || (templateObject_69 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!configuration.nortrace) {
            console.log(chalk_7.default(templateObject_70 || (templateObject_70 = __makeTemplateObject(["{bgWhite.black [Log]} Reference Tracing is enabled."], ["{bgWhite.black [Log]} Reference Tracing is enabled."]))));
            if (flags["--use"]) {
        ...
        if (!runTests) {
            console.log(chalk_7.default(templateObject_71 || (templateObject_71 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_7.default(templateObject_72 || (templateObject_72 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
        ...
        var fileMap = new Map();
        console.log(chalk_7.default(templateObject_73 || (templateObject_73 = __makeTemplateObject(["{bgWhite.black [Log]} Effective command line arguments:"], ["{bgWhite.black [Log]} Effective command line arguments:"]))));
        console.log(chalk_7.default(templateObject_74 || (templateObject_74 = __makeTemplateObject(["  ", ""], ["  ", ""])), flagList.join(" ")));
            ...
            asc.main([file].concat(Array.from(addedTestEntryFiles), flagList), {
                ...
                if (count === 0) {
                    if (runTests) {
                        ...
                        var result = failed
                            ? chalk_7.default(templateObject_75 || (templateObject_75 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_7.default(templateObject_76 || (templateObject_76 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
                        for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                            var error_1 = errors_1[_i];
                            console.log(chalk_7.default(templateObject_77 || (templateObject_77 = __makeTemplateObject(["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "], ["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                        }
...
define("cli/types", ["require", "exports", "chalk", "fs"], function (require, exports, chalk_8, fs_5) {
    ...
    function types(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_8.default(templateObject_78 || (templateObject_78 = __makeTemplateObject(["[Log] Initializing types."], ["[Log] Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_5.default.existsSync(assemblyFolder)) {
            console.log(chalk_8.default(templateObject_79 || (templateObject_79 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_5.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_5.default.existsSync(testFolder)) {
            console.log(chalk_8.default(templateObject_80 || (templateObject_80 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            fs_5.default.mkdirSync(testFolder);
        }
        // Create the types file if it doesn't exist
        if (!fs_5.default.existsSync(typesFile)) {
            console.log(chalk_8.default(templateObject_81 || (templateObject_81 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            fs_5.default.createReadStream(typesFileSource, "utf-8")
                .pipe(fs_5.default.createWriteStream(typesFile, "utf-8"));
        }
    }
    exports.types = types;
    var templateObject_78, templateObject_79, templateObject_80, templateObject_81;
});
