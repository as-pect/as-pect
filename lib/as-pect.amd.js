    ...
    function collectReporter(yargs) {
        ...
        if (targetReporter.startsWith(".")) {
            try {
                ...
                console.log("Cannot find target reporter at", path_2.default.join(process.cwd(), targetReporter));
                console.log(ex);
                process.exit(1);
...
define("cli/run", ["require", "exports", "assemblyscript/cli/asc", "assemblyscript/cli/util/options", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, asc_1, options_1, TestContext_1, fs, loader_1, DefaultTestReporter_3, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, path, chalk_6, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    ...
    function run(yargs, compilerArgs) {
        ...
        try {
            ...
            console.log("");
            console.log(chalk_6.default(templateObject_51 || (templateObject_51 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.log(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.log(chalk_6.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.log(chalk_6.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
