...
define("cli/run", ["require", "exports", "assemblyscript/cli/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "reporter/EmptyReporter", "reporter/SummaryTestReporter", "path", "chalk", "glob"], function (require, exports, asc_1, TestContext_1, fs, loader_1, DefaultTestReporter_2, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, EmptyReporter_1, SummaryTestReporter_1, path, chalk_6, glob_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function run(yargs) {
        ...
        var reporter = configuration.reporter || new DefaultTestReporter_2.DefaultTestReporter();
            ...
            if (targetReporter.startsWith(".")) {
                try {
                    ...
                    if (result) {
                        ...
                        reporter = new DefaultTestReporter_2.DefaultTestReporter();
                    }
                }
                catch (ex) {
...
define("cli/index", ["require", "exports", "chalk", "path", "yargs-parser", "cli/types", "cli/init", "cli/help", "cli/run"], function (require, exports, chalk_7, path_2, yargs_parser_1, types_1, init_1, help_1, run_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function asp(args) {
        ...
        var typesFileSource = path_2.default.join(__dirname, "../../assembly/__tests__/as-pect.d.ts");
...
define("test", ["require", "exports", "cli/index"], function (require, exports, cli_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
