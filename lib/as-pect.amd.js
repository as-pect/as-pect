...
define("reporter/CSVTestReporter", ["require", "exports", "test/TestReporter", "csv-stringify", "fs", "path"], function (require, exports, TestReporter_4, csv_stringify_1, fs_3, path_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CSVTestReporter = /** @class */ (function (_super) {
        ...
        CSVTestReporter.prototype.onStart = function (suite) {
            ...
            var outPath = path_2.join(process.cwd(), dir, base + ".csv");
            this.fileName = fs_3.createWriteStream(outPath, "utf8");
...
define("reporter/JSONTestReporter", ["require", "exports", "test/TestReporter", "fs", "path"], function (require, exports, TestReporter_5, fs_4, path_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var JSONTestReporter = /** @class */ (function (_super) {
        ...
        JSONTestReporter.prototype.onStart = function (suite) {
            var extension = path_3.extname(suite.fileName);
            var dir = path_3.dirname(suite.fileName);
            var base = path_3.basename(suite.fileName, extension);
            var outPath = path_3.join(process.cwd(), dir, base + ".json");
            this.file = fs_4.createWriteStream(outPath, "utf8");
            this.file.write("[");
            this.first = true;
        };
...
define("cli/run", ["require", "exports", "assemblyscript/dist/asc", "assemblyscript/cli/util/options", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, asc_1, options_1, TestContext_1, fs, loader_1, DefaultTestReporter_3, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, path, chalk_6, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
