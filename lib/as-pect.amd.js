...
define("cli", ["require", "exports", "chalk", "path", "glob", "yargs-parser", "assemblyscript/cli/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration"], function (require, exports, chalk_2, path_1, glob_1, yargs_parser_1, asc_1, TestContext_1, fs_1, loader_1, DefaultTestReporter_2, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2) {
    ...
    function asp(args) {
        ...
        if (yargs.argv.i || yargs.argv.init) {
            console.log("");
            console.log(chalk_2.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
            console.log("");
            ...
            if (!fs_1.default.existsSync(testFolder)) {
                ...
                if (!fs_1.default.existsSync(exampleFile)) {
                    console.log(chalk_2.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
            ...
            if (!fs_1.default.existsSync(typesFile)) {
                console.log(chalk_2.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            ...
            if (!fs_1.default.existsSync(configFile)) {
                console.log(chalk_2.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            ...
            console.log(chalk_2.default(templateObject_40 || (templateObject_40 = __makeTemplateObject(["{bgWhite.black [Log]} using configuration ", ""], ["{bgWhite.black [Log]} using configuration ", ""])), configurationPath));
            var configuration_1 = {};
            try {
                ...
                console.log("");
                console.log(chalk_2.default(templateObject_41 || (templateObject_41 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
                console.log(ex);
                process.exit(1);
            }
            // configuration must be an object
            if (!configuration_1) {
                console.log(chalk_2.default(templateObject_42 || (templateObject_42 = __makeTemplateObject(["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."])), configurationPath));
                process.exit(1);
            }
            ...
            if (performanceConfiguration_1.enabled) {
                console.log(chalk_2.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["{bgWhite.black [Log]} Performance has been enabled on this test suite."], ["{bgWhite.black [Log]} Performance has been enabled on this test suite."]))));
            ...
            console.log(chalk_2.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                ...
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (count_1 === 0) {
                        ...
                        var result = failed
                            ? chalk_2.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_2.default(templateObject_46 || (templateObject_46 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
    ...
    exports.asp = asp;
    var templateObject_32, templateObject_33, templateObject_34, templateObject_35, templateObject_36, templateObject_37, templateObject_38, templateObject_39, templateObject_40, templateObject_41, templateObject_42, templateObject_43, templateObject_44, templateObject_45, templateObject_46;
});
