...
define("reporter/SummaryTestReporter", ["require", "exports", "test/TestReporter", "chalk", "reporter/util/createReferenceString"], function (require, exports, TestReporter_5, chalk_2, createReferenceString_2) {
    ...
    var SummaryTestReporter = /** @class */ (function (_super) {
        ...
        SummaryTestReporter.prototype.onFinish = function (suite) {
            ...
            if (passCount === total && suite.testGroups.length === groupPassCount) {
                ...
                for (var _k = 0, _l = suite.testGroups; _k < _l.length; _k++) {
                    ...
                    if (group.pass)
                        continue;
                    suite.stdout.write(chalk_2.default(templateObject_32 || (templateObject_32 = __makeTemplateObject(["  ", "\n"], ["  ", "\\n"])), group.name));
                    if (group.reason)
        ...
        SummaryTestReporter.prototype.onLog = function (logValue) {
            ...
            // log the log message
            if (logValue.pointer > 0) {
                this.stdout.write(chalk_2.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", "\n"], ["     {yellow [Log]:} Reference at address [", "] [hex: 0x", "] ", "\\n"])), pointer, hexPointer, logValue.message));
            }
            else {
                this.stdout.write(chalk_2.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["     {yellow [Log]:} ", "\n"], ["     {yellow [Log]:} ", "\\n"])), logValue.message));
            }
            // if there are bytes to show, create a logging representation of the bytes
            if (logValue.bytes.length > 0) {
                var value = createReferenceString_2.createReferenceString(logValue.bytes, logValue.pointer, logValue.offset);
                this.stdout.write(chalk_2.default(templateObject_39 || (templateObject_39 = __makeTemplateObject(["            {blueBright ", "}\n"], ["            {blueBright ", "}\\n"])), value.split("\n").join("\n            ")));
            }
            this.stdout.write(chalk_2.default(templateObject_40 || (templateObject_40 = __makeTemplateObject(["        {yellow ", "}\n\n"], ["        {yellow ", "}\\n\\n"])), logValue.stack.split("\n").join("\n        ")));
        };
        return SummaryTestReporter;
    }(TestReporter_5.TestReporter));
    exports.SummaryTestReporter = SummaryTestReporter;
    var templateObject_30, templateObject_31, templateObject_32, templateObject_33, templateObject_34, templateObject_35, templateObject_36, templateObject_37, templateObject_38, templateObject_39, templateObject_40;
});
...
define("cli/types", ["require", "exports", "chalk", "fs"], function (require, exports, chalk_3, fs_3) {
    ...
    function types(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_3.default(templateObject_41 || (templateObject_41 = __makeTemplateObject(["[Log] Initializing types."], ["[Log] Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_3.default.existsSync(assemblyFolder)) {
            console.log(chalk_3.default(templateObject_42 || (templateObject_42 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_3.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_3.default.existsSync(testFolder)) {
            console.log(chalk_3.default(templateObject_43 || (templateObject_43 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            fs_3.default.mkdirSync(testFolder);
        }
        // Create the types file if it doesn't exist
        if (!fs_3.default.existsSync(typesFile)) {
            console.log(chalk_3.default(templateObject_44 || (templateObject_44 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            fs_3.default.createReadStream(typesFileSource, "utf-8")
                .pipe(fs_3.default.createWriteStream(typesFile, "utf-8"));
        }
    }
    exports.types = types;
    var templateObject_41, templateObject_42, templateObject_43, templateObject_44;
});
define("cli/init", ["require", "exports", "chalk", "path", "fs"], function (require, exports, chalk_4, path_3, fs_4) {
    ...
    function init(assemblyFolder, testFolder, typesFile, typesFileSource) {
        console.log("");
        console.log(chalk_4.default(templateObject_45 || (templateObject_45 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
        console.log("");
        // create the assembly folder if it doesn't exist
        if (!fs_4.default.existsSync(assemblyFolder)) {
            console.log(chalk_4.default(templateObject_46 || (templateObject_46 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            fs_4.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_4.default.existsSync(testFolder)) {
            console.log(chalk_4.default(templateObject_47 || (templateObject_47 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
            ...
            if (!fs_4.default.existsSync(exampleFile)) {
                console.log(chalk_4.default(templateObject_48 || (templateObject_48 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
        ...
        if (!fs_4.default.existsSync(typesFile)) {
            console.log(chalk_4.default(templateObject_49 || (templateObject_49 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
        ...
        if (!fs_4.default.existsSync(configFile)) {
            console.log(chalk_4.default(templateObject_50 || (templateObject_50 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            fs_4.default.createReadStream(configFileSource, "utf-8")
                .pipe(fs_4.default.createWriteStream(configFile, "utf-8"));
        }
    }
    exports.init = init;
    var templateObject_45, templateObject_46, templateObject_47, templateObject_48, templateObject_49, templateObject_50;
});
...
define("cli/util/collectReporter", ["require", "exports", "reporter/DefaultTestReporter", "reporter/EmptyReporter", "reporter/SummaryTestReporter", "path", "reporter/CSVTestReporter", "reporter/JSONTestReporter", "querystring", "chalk"], function (require, exports, DefaultTestReporter_2, EmptyReporter_1, SummaryTestReporter_1, path_4, CSVTestReporter_1, JSONTestReporter_1, querystring_1, chalk_6) {
    ...
    function collectReporter(yargs) {
        ...
        if (targetReporter.startsWith(".")) {
            try {
                var reporterPath = path_4.default.join(process.cwd(), targetReporter);
                ...
                if (reporterResult) {
                    ...
                    console.log(chalk_6.default(templateObject_52 || (templateObject_52 = __makeTemplateObject(["{bgBlack.yellow [Warning]} Cannot find reporter at {yellow ", "}, defaulting to DefaultTestReporter."], ["{bgBlack.yellow [Warning]} Cannot find reporter at {yellow ", "}, defaulting to DefaultTestReporter."])), reporterPath));
                    return new DefaultTestReporter_2.DefaultTestReporter(options);
                }
            }
            catch (ex) {
                console.log(chalk_6.default(templateObject_53 || (templateObject_53 = __makeTemplateObject(["{bgBlack.yellow [Error]} An error occured while trying to resolve a reporter at {yellow ", "}."], ["{bgBlack.yellow [Error]} An error occured while trying to resolve a reporter at {yellow ", "}."])), targetReporter));
                console.error(ex);
                process.exit(1);
    ...
    var templateObject_52, templateObject_53;
});
...
define("cli/run", ["require", "exports", "assemblyscript/dist/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "util/IPerformanceConfiguration", "path", "chalk", "glob", "cli/util/collectPerformanceConfiguration", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, asc, TestContext_1, fs, loader_1, DefaultTestReporter_3, perf_hooks_2, timeDifference_2, IPerformanceConfiguration_2, path, chalk_7, glob_2, collectPerformanceConfiguration_1, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    ...
    function run(yargs, compilerArgs) {
        ...
        console.log(chalk_7.default(templateObject_54 || (templateObject_54 = __makeTemplateObject(["{bgWhite.black [Log]} Using configuration ", ""], ["{bgWhite.black [Log]} Using configuration ", ""])), configurationPath));
        var configuration = {};
        try {
            ...
            console.error("");
            console.error(chalk_7.default(templateObject_55 || (templateObject_55 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.error(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.error(chalk_7.default(templateObject_56 || (templateObject_56 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.error(chalk_7.default(templateObject_57 || (templateObject_57 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold [", "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        console.log(chalk_7.default(templateObject_58 || (templateObject_58 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        ...
        if (!configuration.testRegex) {
            ...
            console.log(chalk_7.default(templateObject_59 || (templateObject_59 = __makeTemplateObject(["{bgWhite.black [Log]} Running tests that match: ", ""], ["{bgWhite.black [Log]} Running tests that match: ", ""])), testRegex.source));
        }
        if (!configuration.groupRegex) {
            ...
            console.log(chalk_7.default(templateObject_60 || (templateObject_60 = __makeTemplateObject(["{bgWhite.black [Log]} Running groups that match: ", ""], ["{bgWhite.black [Log]} Running groups that match: ", ""])), groupRegex.source));
        }
        /**
        ...
        if (outputBinary) {
            console.log(chalk_7.default(templateObject_61 || (templateObject_61 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!configuration.nortrace) {
            console.log(chalk_7.default(templateObject_62 || (templateObject_62 = __makeTemplateObject(["{bgWhite.black [Log]} Reference Tracing is enabled."], ["{bgWhite.black [Log]} Reference Tracing is enabled."]))));
            if (flags["--use"]) {
        ...
        if (!runTests) {
            console.log(chalk_7.default(templateObject_63 || (templateObject_63 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_7.default(templateObject_64 || (templateObject_64 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) + compilerArgs.join(" "));
        }
        ...
        var fileMap = new Map();
        console.log(chalk_7.default(templateObject_65 || (templateObject_65 = __makeTemplateObject(["{bgWhite.black [Log]} Effective command line arguments:"], ["{bgWhite.black [Log]} Effective command line arguments:"]))));
        console.log(chalk_7.default(templateObject_66 || (templateObject_66 = __makeTemplateObject(["  ", ""], ["  ", ""])), flagList.join(" ")));
            ...
            asc.main([file].concat(Array.from(addedTestEntryFiles), flagList), {
                ...
                if (count === 0) {
                    if (runTests) {
                        ...
                        var result = failed
                            ? chalk_7.default(templateObject_67 || (templateObject_67 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_7.default(templateObject_68 || (templateObject_68 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
                        for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                            var error_1 = errors_1[_i];
                            console.log(chalk_7.default(templateObject_69 || (templateObject_69 = __makeTemplateObject(["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "], ["\n   [Error]: {red ", "}: ", "\n   [Stack]: {yellow ", "}\n  "])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                        }
    ...
    exports.run = run;
    var templateObject_54, templateObject_55, templateObject_56, templateObject_57, templateObject_58, templateObject_59, templateObject_60, templateObject_61, templateObject_62, templateObject_63, templateObject_64, templateObject_65, templateObject_66, templateObject_67, templateObject_68, templateObject_69;
});
define("cli/index", ["require", "exports", "chalk", "path", "yargs-parser", "cli/types", "cli/init", "cli/help", "cli/run"], function (require, exports, chalk_8, path_5, yargs_parser_1, types_1, init_1, help_1, run_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function asp(args) {
        ...
        if (!(yargs.argv.v || yargs.argv.version)) {
            console.log(chalk_8.default(templateObject_70 || (templateObject_70 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\___/\\___/\\__/     \n                    /_/                        }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "], ["{bold.bgWhite.black ",
                "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/     \n                    /_/                        }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "])), "", pkg.version));
        }
