...
define("test/TestContext", ["require", "exports", "test/TestGroup", "util/LogValue", "util/ActualValue", "test/TestResult", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference", "test/RunContext"], function (require, exports, TestGroup_1, LogValue_2, ActualValue_1, TestResult_1, DefaultTestReporter_1, perf_hooks_1, timeDifference_1, RunContext_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("cli", ["require", "exports", "chalk", "path", "glob", "yargs-parser", "assemblyscript/cli/asc", "test/TestContext", "fs", "assemblyscript/lib/loader", "reporter/DefaultTestReporter", "perf_hooks", "util/timeDifference"], function (require, exports, chalk_2, path_1, glob_1, yargs_parser_1, asc_1, TestContext_1, fs_1, loader_1, DefaultTestReporter_2, perf_hooks_2, timeDifference_2) {
    ...
    function asp(args) {
        ...
        if (yargs.argv.i || yargs.argv.init) {
            ...
            console.log(chalk_2.default(templateObject_32 || (templateObject_32 = __makeTemplateObject(["\n  {bold.blueBright SYNTAX}\n    {bold.green asp} --init                          Create a test config, an assembly/__tests__ folder and exit.\n    {bold.green asp} -i\n    {bold.green asp} --config as-pect.config.js      Use a specified configuration\n    {bold.green asp} -c as-pect.config.js\n    {bold.green asp} --version                       View the version.\n    {bold.green asp} -v\n\n  {bold.blueBright TEST OPTIONS}\n    {bold.green --performance}                        Enable performance statistics.\n    {bold.green --min-samples [number]}               Set the minimum number of samples to run for each test.\n    {bold.green --max-samples [number]}               Set the maximum number of samples to run for each test.\n    {bold.green --min-test-run-time [number]}         Set the minimum test run time in milliseconds.\n    {bold.green --max-test-run-time [number]}         Set the maximum test run time in milliseconds.\n    {bold.green --report-median(=false)?}             Enable/Disable reporting of the median time.\n    {bold.green --report-average(=false)?}            Enable reporting of the average time.\n    {bold.green --report-standard-deviation(=false?)} Enable reporting of the standard deviation.\n    {bold.green --report-max(=false?)}                Enable reporting of the largest run time.\n    {bold.green --report-min(=false?)}                Enable reporting of the smallest run time.\n  "], ["\n  {bold.blueBright SYNTAX}\n    {bold.green asp} --init                          Create a test config, an assembly/__tests__ folder and exit.\n    {bold.green asp} -i\n    {bold.green asp} --config as-pect.config.js      Use a specified configuration\n    {bold.green asp} -c as-pect.config.js\n    {bold.green asp} --version                       View the version.\n    {bold.green asp} -v\n\n  {bold.blueBright TEST OPTIONS}\n    {bold.green --performance}                        Enable performance statistics.\n    {bold.green --min-samples [number]}               Set the minimum number of samples to run for each test.\n    {bold.green --max-samples [number]}               Set the maximum number of samples to run for each test.\n    {bold.green --min-test-run-time [number]}         Set the minimum test run time in milliseconds.\n    {bold.green --max-test-run-time [number]}         Set the maximum test run time in milliseconds.\n    {bold.green --report-median(=false)?}             Enable/Disable reporting of the median time.\n    {bold.green --report-average(=false)?}            Enable reporting of the average time.\n    {bold.green --report-standard-deviation(=false?)} Enable reporting of the standard deviation.\n    {bold.green --report-max(=false?)}                Enable reporting of the largest run time.\n    {bold.green --report-min(=false?)}                Enable reporting of the smallest run time.\n  "]))));
        }
            ...
            if (performanceConfiguration.enabled) {
                console.log(chalk_2.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["{bgWhite.black [Log]} Performance has been enabled on this test suite."], ["{bgWhite.black [Log]} Performance has been enabled on this test suite."]))));
            ...
            console.log(chalk_2.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
            ...
            Array.from(testEntryFiles_1).forEach(function (file, i) {
                ...
                asc_1.default.main([file].concat(Array.from(addedTestEntryFiles_1), flagList_1), {
                    ...
                    if (count_1 === 0) {
                        ...
                        var result = failed
                            ? chalk_2.default(templateObject_38 || (templateObject_38 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_2.default(templateObject_39 || (templateObject_39 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                        console.log("~".repeat(process.stdout.columns - 10));
    ...
    exports.asp = asp;
    var templateObject_25, templateObject_26, templateObject_27, templateObject_28, templateObject_29, templateObject_30, templateObject_31, templateObject_32, templateObject_33, templateObject_34, templateObject_35, templateObject_36, templateObject_37, templateObject_38, templateObject_39;
});
