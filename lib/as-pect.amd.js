...
define("cli/util/collectReporter", ["require", "exports", "querystring", "chalk", "reporter/SummaryReporter", "reporter/CombinationReporter"], function (require, exports, querystring_1, chalk_6, SummaryReporter_2, CombinationReporter_2) {
    ...
    function collectReporter(yargs) {
        ...
        if (yargs.csv) {
            ...
            process.stdout.write(chalk_6.default(templateObject_60 || (templateObject_60 = __makeTemplateObject(["{bgWhite.black [Log]} Using {yellow CSVReporter}\n"], ["{bgWhite.black [Log]} Using {yellow CSVReporter}\\n"]))));
        }
        if (yargs.json) {
            ...
            process.stdout.write(chalk_6.default(templateObject_61 || (templateObject_61 = __makeTemplateObject(["{bgWhite.black [Log]} Using {yellow JSONReporter}\n"], ["{bgWhite.black [Log]} Using {yellow JSONReporter}\\n"]))));
        }
        if (yargs.summary) {
        ...
        if (yargs.verbose) {
            ...
            process.stdout.write(chalk_6.default(templateObject_63 || (templateObject_63 = __makeTemplateObject(["{bgWhite.black [Log]} Using {yellow VerboseReporter}\n"], ["{bgWhite.black [Log]} Using {yellow VerboseReporter}\\n"]))));
        }
        if (yargs.reporter) {
        ...
        if (reporters.length === 0) {
            process.stdout.write(chalk_6.default(templateObject_66 || (templateObject_66 = __makeTemplateObject(["{bgWhite.black [Log]} Using {yellow SummaryReporter}\n"], ["{bgWhite.black [Log]} Using {yellow SummaryReporter}\\n"]))));
...
define("cli/run", ["require", "exports", "test/TestContext", "fs", "perf_hooks", "util/timeDifference", "path", "chalk", "glob", "cli/util/collectReporter", "cli/util/getTestEntryFiles", "cli/util/writeFile"], function (require, exports, TestContext_2, fs, perf_hooks_2, timeDifference_2, path, chalk_7, glob_2, collectReporter_1, getTestEntryFiles_1, writeFile_1) {
    ...
    function run(cliOptions, compilerArgs) {
        ...
        if (cliOptions.workers !== 0) {
            ...
            console.log(chalk_7.default(templateObject_68 || (templateObject_68 = __makeTemplateObject(["{bgWhite.black [Log]} Using experimental compiler worklets: {yellow ", " worklets}"], ["{bgWhite.black [Log]} Using experimental compiler worklets: {yellow ", " worklets}"])), worklets.length.toString()));
        }
        /**
         ...
         * running.
         */
        console.log(chalk_7.default(templateObject_69 || (templateObject_69 = __makeTemplateObject(["{bgWhite.black [Log]} Loading asc compiler"], ["{bgWhite.black [Log]} Loading asc compiler"]))));
        var asc;
        ...
        try {
            ...
            console.error(chalk_7.default(templateObject_70 || (templateObject_70 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), cliOptions.compiler));
            console.error(ex);
            process.exit(1);
        }
        console.log(chalk_7.default(templateObject_71 || (templateObject_71 = __makeTemplateObject(["{bgWhite.black [Log]} Compiler loaded in {yellow ", "ms}."], ["{bgWhite.black [Log]} Compiler loaded in {yellow ",
        ...
        console.log(chalk_7.default(templateObject_72 || (templateObject_72 = __makeTemplateObject(["{bgWhite.black [Log]} Using configuration {yellow ", "}"], ["{bgWhite.black [Log]} Using configuration {yellow ", "}"])), configurationPath));
        var configuration = {};
        try {
            ...
            console.error("");
            console.error(chalk_7.default(templateObject_73 || (templateObject_73 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
            console.error(ex);
            process.exit(1);
        }
        // configuration must be an object
        if (!configuration) {
            console.error(chalk_7.default(templateObject_74 || (templateObject_74 = __makeTemplateObject(["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} Configuration at {bold [", "]} is null or not an object."])), configurationPath));
            process.exit(1);
        }
        ...
        if (unknown.length > 0) {
            console.error(chalk_7.default(templateObject_75 || (templateObject_75 = __makeTemplateObject(["{bgRedBright.black [Error]} Unknown compiler arguments {bold.yellow [", "]}."], ["{bgRedBright.black [Error]} Unknown compiler arguments {bold.yellow [",
                "]}."])), unknown.join(", ")));
            process.exit(1);
        }
        ...
        if (flags.hasOwnProperty("-O3") ||
            ...
            console.log(chalk_7.default(templateObject_76 || (templateObject_76 = __makeTemplateObject(["{yellow [Warning]} Using optimizations. This may result in slow test compilation times."], ["{yellow [Warning]} Using optimizations. This may result in slow test compilation times."]))));
        }
        ...
        console.log(chalk_7.default(templateObject_77 || (templateObject_77 = __makeTemplateObject(["{bgWhite.black [Log]} Including files: ", ""], ["{bgWhite.black [Log]} Including files: ", ""])), include.join(", ")));
        // Create the test and group matchers
        var testRegex = new RegExp(cliOptions.test, "i");
        configuration.testRegex = testRegex;
        console.log(chalk_7.default(templateObject_78 || (templateObject_78 = __makeTemplateObject(["{bgWhite.black [Log]} Running tests that match: {yellow ", "}"], ["{bgWhite.black [Log]} Running tests that match: {yellow ", "}"])), testRegex.source));
        var groupRegex = new RegExp(cliOptions.group, "i");
        configuration.groupRegex = groupRegex;
        console.log(chalk_7.default(templateObject_79 || (templateObject_79 = __makeTemplateObject(["{bgWhite.black [Log]} Running groups that match: {yellow ", "}"], ["{bgWhite.black [Log]} Running groups that match: {yellow ", "}"])), groupRegex.source));
        /**
        ...
        if (outputBinary) {
            console.log(chalk_7.default(templateObject_80 || (templateObject_80 = __makeTemplateObject(["{bgWhite.black [Log]} Outputing Binary *.wasm files."], ["{bgWhite.black [Log]} Outputing Binary *.wasm files."]))));
        }
        /**
        ...
        if (!configuration.nortrace) {
            console.log(chalk_7.default(templateObject_81 || (templateObject_81 = __makeTemplateObject(["{bgWhite.black [Log]} Reference Tracing is enabled."], ["{bgWhite.black [Log]} Reference Tracing is enabled."]))));
            if (flags["--use"]) {
        ...
        if (!runTests) {
            console.log(chalk_7.default(templateObject_82 || (templateObject_82 = __makeTemplateObject(["{bgWhite.black [Log]} Not running tests, only outputting files."], ["{bgWhite.black [Log]} Not running tests, only outputting files."]))));
        }
        if (compilerArgs.length > 0) {
            console.log(chalk_7.default(templateObject_83 || (templateObject_83 = __makeTemplateObject(["{bgWhite.black [Log]} Adding compiler arguments: "], ["{bgWhite.black [Log]} Adding compiler arguments: "]))) +
                compilerArgs.join(" "));
        }
        ...
        var fileMap = new Map();
        console.log(chalk_7.default(templateObject_84 || (templateObject_84 = __makeTemplateObject(["{bgWhite.black [Log]} Effective command line args:"], ["{bgWhite.black [Log]} Effective command line args:"]))));
        console.log(chalk_7.default(templateObject_85 || (templateObject_85 = __makeTemplateObject(["  {green [TestFile.ts]} {yellow ", "} ", ""], ["  {green [TestFile.ts]} {yellow ",
        ...
        function runBinary(error, file, binary) {
            ...
            if (error) {
                console.error(chalk_7.default(templateObject_86 || (templateObject_86 = __makeTemplateObject(["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."], ["{red [Error]} There was a compilation error when trying to create the wasm binary for file: ", "."])), file));
                console.error(error);
                return process.exit(1);
            }
            // if the binary wasn't emitted, stop the test suite
            if (!binary) {
                console.error(chalk_7.default(templateObject_87 || (templateObject_87 = __makeTemplateObject(["{red [Error]} There was no output binary file: ", ". Did you forget to emit the binary with {yellow --binaryFile}?"], ["{red [Error]} There was no output binary file: ", ". Did you forget to emit the binary with {yellow --binaryFile}?"])), file));
                return process.exit(1);
            }
            if (runTests) {
            ...
            if (count === 0) {
                if (runTests) {
                    ...
                    var result = failed ? chalk_7.default(templateObject_88 || (templateObject_88 = __makeTemplateObject(["{red \u2716 FAIL}"], ["{red \u2716 FAIL}"]))) : chalk_7.default(templateObject_89 || (templateObject_89 = __makeTemplateObject(["{green \u2714 PASS}"], ["{green \u2714 PASS}"])));
                    console.log("~".repeat(process.stdout.columns - 10));
                    for (var _i = 0, errors_1 = errors; _i < errors_1.length; _i++) {
                        var error_1 = errors_1[_i];
                        console.log(chalk_7.default(templateObject_90 || (templateObject_90 = __makeTemplateObject(["\n [Error]: {red ", "}: ", "\n [Stack]: {yellow ", "}\n"], ["\n [Error]: {red ", "}: ", "\n [Stack]: {yellow ", "}\n"])), error_1.type, error_1.message, error_1.stackTrace.split("\n").join("\n            ")));
                    }
...
define("cli/types", ["require", "exports", "chalk", "fs", "path"], function (require, exports, chalk_8, fs_6, path_5) {
    ...
    function types() {
        console.log("");
        console.log(chalk_8.default(templateObject_91 || (templateObject_91 = __makeTemplateObject(["{bgWhite.black [Log]} Initializing types."], ["{bgWhite.black [Log]} Initializing types."]))));
        console.log("");
        // Create the assembly folder if it doesn't exist
        if (!fs_6.default.existsSync(assemblyFolder)) {
            console.log(chalk_8.default(templateObject_92 || (templateObject_92 = __makeTemplateObject(["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/}"], ["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/}"]))));
            fs_6.default.mkdirSync(assemblyFolder);
        }
        // Create the test folder if it doesn't exist
        if (!fs_6.default.existsSync(testFolder)) {
            console.log(chalk_8.default(templateObject_93 || (templateObject_93 = __makeTemplateObject(["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/__tests__/}"], ["{bgWhite.black [Log]} Creating folder: {yellow ./assembly/__tests__/}"]))));
            fs_6.default.mkdirSync(testFolder);
        }
        // Always create the types file
        console.log(chalk_8.default(templateObject_94 || (templateObject_94 = __makeTemplateObject(["{bgWhite.black [Log]} Creating file: {yellow assembly/__tests__/as-pect.d.ts}"], ["{bgWhite.black [Log]} Creating file: {yellow assembly/__tests__/as-pect.d.ts}"]))));
        fs_6.default.createReadStream(typesFileSource, "utf-8").pipe(fs_6.default.createWriteStream(typesFile, "utf-8"));
    }
    exports.types = types;
    var templateObject_91, templateObject_92, templateObject_93, templateObject_94;
});
define("cli/util/asciiArt", ["require", "exports", "chalk"], function (require, exports, chalk_9) {
    ...
    function printAsciiArt(version) {
        console.log(chalk_9.default(templateObject_95 || (templateObject_95 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\___/\\___/\\__/     \n                    /_/                        }\n\n\u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n"], ["{bold.bgWhite.black ", "       ___   _____                       __    \n      /   | / ___/      ____  ___  _____/ /_   \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/   \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_     \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/     \n                    /_/                        }\n\n\u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n"])), "", version));
    }
...
//# sourceMappingURL=data:application/json;base64,