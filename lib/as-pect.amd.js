...
define("test/TestRunner", ["require", "exports", "test/TestSuite", "test/TestGroup", "assemblyscript/lib/loader", "test/TestResult", "reporter/DefaultReporter"], function (require, exports, TestSuite_1, TestGroup_1, loader_1, TestResult_1, DefaultReporter_1) {
    ...
    var TestRunner = /** @class */ (function () {
         ...
         * @param {number} offset - The offset of the reference.
         */
        TestRunner.prototype.createReferenceString = function (pointer, offset) {
            var result = "  ";
...
define("cli", ["require", "exports", "chalk", "path", "glob", "yargs-parser", "lodash.uniq", "assemblyscript/cli/asc", "test/TestRunner", "fs", "reporter/DefaultReporter"], function (require, exports, chalk_2, path_1, glob_1, yargs_parser_1, lodash_uniq_1, asc_1, TestRunner_1, fs_1, DefaultReporter_2) {
    ...
    function asp(args) {
        ...
        if (!(yargs.argv.v || yargs.argv.version)) {
            console.log(chalk_2.default(templateObject_23 || (templateObject_23 = __makeTemplateObject(["{bold.bgWhite.black ", "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\__ \\______/ __ \\/ _ \\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\___/\\___/\\__/   \n                    /_/                      }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "], ["{bold.bgWhite.black ",
                "       ___   _____                       __  \n      /   | / ___/      ____  ___  _____/ /_ \n     / /| | \\\\__ \\\\______/ __ \\\\/ _ \\\\/ ___/ __/ \n    / ___ |___/ /_____/ /_/ /  __/ /__/ /_   \n   /_/  |_/____/     / .___/\\\\___/\\\\___/\\\\__/   \n                    /_/                      }\n\n  \u26A1AS-pect\u26A1 Test suite runner {bgGreenBright.black [", "]}\n  "])), "", pkg.version));
        }
        // init script
        if (yargs.argv.i || yargs.argv.init) {
            console.log("");
            console.log(chalk_2.default(templateObject_24 || (templateObject_24 = __makeTemplateObject(["[Log] Initializing test suite files."], ["[Log] Initializing test suite files."]))));
            console.log("");
            ...
            if (!fs_1.default.existsSync(assemblyFolder)) {
                console.log(chalk_2.default(templateObject_25 || (templateObject_25 = __makeTemplateObject(["[Log] Creating folder: ./assembly/"], ["[Log] Creating folder: ./assembly/"]))));
            ...
            if (!fs_1.default.existsSync(testFolder)) {
                console.log(chalk_2.default(templateObject_26 || (templateObject_26 = __makeTemplateObject(["[Log] Creating folder: ./assembly/__tests__/"], ["[Log] Creating folder: ./assembly/__tests__/"]))));
                ...
                if (!fs_1.default.existsSync(exampleFile)) {
                    console.log(chalk_2.default(templateObject_27 || (templateObject_27 = __makeTemplateObject(["[Log] Creating file: ./assembly/__tests__/example.spec.ts"], ["[Log] Creating file: ./assembly/__tests__/example.spec.ts"]))));
            ...
            if (!fs_1.default.existsSync(typesFile)) {
                console.log(chalk_2.default(templateObject_28 || (templateObject_28 = __makeTemplateObject(["[Log] Creating file: assembly/__tests__/as-pect.d.ts"], ["[Log] Creating file: assembly/__tests__/as-pect.d.ts"]))));
            ...
            if (!fs_1.default.existsSync(configFile)) {
                console.log(chalk_2.default(templateObject_29 || (templateObject_29 = __makeTemplateObject(["[Log] Creating file: as-pect.config.js"], ["[Log] Creating file: as-pect.config.js"]))));
            ...
            console.log(chalk_2.default(templateObject_31 || (templateObject_31 = __makeTemplateObject(["{bgWhite.black [Log]} using configuration ", ""], ["{bgWhite.black [Log]} using configuration ", ""])), configurationPath));
            ...
            try {
                ...
                console.log("");
                console.log(chalk_2.default(templateObject_32 || (templateObject_32 = __makeTemplateObject(["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."], ["{bgRedBright.black [Error]} There was a problem loading {bold [", "]}."])), configurationPath));
                console.log(ex);
                process.exit(1);
            }
            // configuration must be an object
            if (!configuration_1) {
                console.log(chalk_2.default(templateObject_33 || (templateObject_33 = __makeTemplateObject(["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."], ["{bgRedBright.black [Error]} configuration at {bold [", "]} is null or not an object."])), configurationPath));
                process.exit(1);
            }
            var reporter_1 = configuration_1.reporter || new DefaultReporter_2.DefaultReporter();
            // include all the file globs
            reporter_1.onLog(null, chalk_2.default(templateObject_34 || (templateObject_34 = __makeTemplateObject(["including files ", ""], ["including files ", ""])), configuration_1.include.join(", ")));
            var files_1 = [];
            // for each pattern
            ...
            files_1.forEach(function (file, i) {
                reporter_1.onLog(null, chalk_2.default(templateObject_35 || (templateObject_35 = __makeTemplateObject(["Compiling: ", " ", " / ", ""], ["Compiling: ", " ", " / ", ""])), file, (i + 1).toString(), files_1.length.toString()));
                ...
                asc_1.default.main([
                    ...
                    if (error) {
                        reporter_1.onLog(null, chalk_2.default(templateObject_36 || (templateObject_36 = __makeTemplateObject(["There was a compilation error when trying to create the wasm binary for file: ", "."], ["There was a compilation error when trying to create the wasm binary for file: ", "."])), file));
                        console.error(error);
                        process.exit(1);
                        return;
                    }
                    ...
                    if (!binaries_1[i]) {
                        reporter_1.onLog(null, chalk_2.default(templateObject_37 || (templateObject_37 = __makeTemplateObject(["There was no output binary file: ", ". Did you forget to emit the binary?"], ["There was no output binary file: ", ". Did you forget to emit the binary?"])), file));
                        process.exit(1);
                        return;
                    }
    ...
    exports.asp = asp;
    var templateObject_23, templateObject_24, templateObject_25, templateObject_26, templateObject_27, templateObject_28, templateObject_29, templateObject_30, templateObject_31, templateObject_32, templateObject_33, templateObject_34, templateObject_35, templateObject_36, templateObject_37;
});
