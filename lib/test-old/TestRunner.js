...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./TestSuite", "./TestGroup", "assemblyscript/lib/loader", "../test/TestResult", "../reporter/DefaultTestReporter", "../util/LogValue", "../util/ActualValue"], factory);
    }
    ...
    var TestRunner = /** @class */ (function () {
        ...
        TestRunner.prototype.runBuffer = function (filename, buffer, imports, reporter) {
            if (imports === void 0) { imports = {}; }
            if (reporter === void 0) { reporter = new DefaultTestReporter_1.DefaultReporter(); }
         ...
         */
        TestRunner.prototype.reportNegatedTest = function (testNamePointer, callback, message) {
            var group = this.suite.testGroups[this.suite.testGroups.length - 1];
            group.testFunctionPointers.push(callback);
            group.testNamePointers.push(testNamePointer);
         ...
         * @param {1 | 0} negated - An indicator if the expectation is negated.
         */
        TestRunner.prototype.reportExpectedFinite = function (negated) {
            var value = new ActualValue_1.ActualValue();
            value.group = this.currentGroup;
         ...
         */
        TestRunner.prototype.debug = function () {
            debugger;
        };
        /**
