...
//  */
// export function collectPerformanceConfiguration(yargs: Options, performanceConfiguration: IPerformanceConfiguration) {
//   if (yargs.argv.hasOwnProperty("performance"))
//     performanceConfiguration.enabled = yargs.performance !== "false";
//   // gather all the flags
//   if (yargs.argv.hasOwnProperty("maxSamples"))
//     performanceConfiguration.maxSamples = yargs.maxSamples
//   if (yargs.argv.hasOwnProperty("maxTestRunTime"))
//     performanceConfiguration.maxTestRunTime = parseFloat(yargs.maxTestRunTime.toString());
//   if (yargs.argv.hasOwnProperty("maxTestRunTime"))
