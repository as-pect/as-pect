(module
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 55 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $start:assembly/__tests__/unmanaged.spec~anonymous|0~anonymous|0 (; 56 ;)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $start:assembly/__tests__/unmanaged.spec~anonymous|0 (; 58 ;)
  i32.const 256
  i32.const 1
 ...
 (func $start:assembly/__tests__/unmanaged.spec (; 61 ;)
  i32.const 192
  i32.const 2
 ...
 (func $assembly/internal/report/Actual/__sendActual (; 64 ;)
  (local $0 i32)
  block $break|0
   block $case9|0
    block $case8|0
 ...
 (func $assembly/internal/report/Expected/__sendExpected (; 65 ;)
  (local $0 i32)
  block $break|0
   block $case11|0
    block $case10|0
 ...
 (func $assembly/internal/Expectation/__cleanup (; 69 ;)
  call $assembly/internal/report/Expected/Expected.clear
  call $assembly/internal/report/Actual/Actual.clear
 )
 (func $~start (; 70 ;)
 ...
 (func $~lib/rt/pure/__collect (; 71 ;)
  return
 )
 (func $~lib/rt/tlsf/freeBlock (; 72 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  i32.load
  local.set $2
 ...
 (func $~lib/rt/pure/__visit (; 74 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
