...
describe("toBeCloseTo", () => {
   ...
   */
  throws(
    "should throw if the expected values are close",
    () => {
   ...
   */
  throws(
    "should throw if the expected value is not close",
    () => {
   ...
   */
  throws(
    "should throw if the actual value is NaN",
    () => {
   ...
   */
  throws(
    "should throw if both values are NaN",
    () => {
