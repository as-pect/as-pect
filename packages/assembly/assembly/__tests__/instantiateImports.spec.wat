(module
 ...
 (data (i32.const 576) "\06\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\98\04\01\00\00\00\00\00\93\00\00\00\02\00\00\00")
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32> (; 30 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32>|trampoline (; 35 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  block $1of1
   block $0of1
 ...
 (func $assembly/internal/Actual/Actual.report<i32> (; 38 ;) (param $0 i32)
  (local $1 i32)
  i32.const 1
  global.set $~argumentsLength
  local.get $0
 ...
 (func $assembly/internal/Expected/Expected.report<i32> (; 39 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  i32.const 1
  global.set $~argumentsLength
  local.get $0
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 42 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $2
 ...
 (func $start:assembly/__tests__/instantiateImports.spec~anonymous|0~anonymous|0 (; 43 ;)
  (local $0 i32)
  i32.const 42
 ...
 (func $start:assembly/__tests__/instantiateImports.spec~anonymous|0 (; 44 ;)
  i32.const 272
  i32.const 1
  call $assembly/internal/Test/test
 )
 (func $start:assembly/__tests__/instantiateImports.spec (; 45 ;)
  i32.const 192
  i32.const 2
 ...
 (func $assembly/internal/call/__call (; 47 ;) (param $0 i32)
  i32.const 0
  global.set $~argumentsLength
  local.get $0
  call_indirect (type $none_=>_none)
 )
 (func $assembly/internal/log/__ignoreLogs (; 48 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 49 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 50 ;) (result i32)
  i32.const 5
 )
 (func $~start (; 51 ;)
  global.get $~started
 ...
 (func $~lib/rt/tlsf/freeBlock (; 53 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  i32.load
  local.set $2
 ...
 (func $~lib/map/Map<usize,i32>#__visit_impl (; 56 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 57 ;) (param $0 i32) (param $1 i32)
  nop
 )
 (func $~lib/rt/__visit_members (; 58 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  block $block$4$break
