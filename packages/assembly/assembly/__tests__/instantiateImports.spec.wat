(module
 ...
 (table $0 4 funcref)
 (elem (i32.const 1) $start:assembly/__tests__/instantiateImports.spec~anonymous|0~anonymous|0 $start:assembly/internal/noOp~anonymous|0 $start:assembly/__tests__/instantiateImports.spec~anonymous|0)
 ...
 (func $assembly/internal/Box/Box<i32>#constructor (; 28 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32> (; 29 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $1
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32>|trampoline (; 34 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  block $2of2
   block $1of2
 ...
 (func $assembly/internal/Test/test (; 45 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  i32.const 0
 ...
 (func $start:assembly/__tests__/instantiateImports.spec~anonymous|0 (; 46 ;)
  i32.const 272
  i32.const 1
  call $assembly/internal/Test/test
 )
 (func $assembly/internal/Test/describe (; 47 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  i32.const 1
 ...
 (func $start:assembly/__tests__/instantiateImports.spec (; 48 ;)
  i32.const 192
  i32.const 3
  call $assembly/internal/Test/describe
 )
 (func $assembly/internal/call/__call (; 49 ;) (param $0 i32)
  i32.const 0
  global.set $~argumentsLength
  local.get $0
  call_indirect (type $none_=>_none)
 )
 (func $assembly/internal/log/__ignoreLogs (; 50 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 51 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 52 ;) (result i32)
  i32.const 6
 )
 (func $~start (; 53 ;)
  global.get $~started
 ...
 (func $~lib/rt/tlsf/freeBlock (; 55 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  i32.load
  local.set $2
 ...
 (func $~lib/rt/pure/__visit (; 57 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
 ...
 (func $~lib/map/Map<usize,i32>#__visit_impl (; 58 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 59 ;) (param $0 i32) (param $1 i32)
  nop
 )
