(module
 ...
 (func $assembly/internal/performance/Performance.enabled (; 60 ;) (param $0 i32)
  local.get $0
  call $assembly/internal/performance/performanceEnabled
 )
 (func $assembly/internal/performance/Performance.maxSamples (; 61 ;) (param $0 f64)
  local.get $0
  call $assembly/internal/performance/maxSamples
 )
 (func $assembly/internal/log/log<f64> (; 62 ;) (param $0 f64)
 ...
 (func $start:assembly/__tests__/performance.spec~anonymous|0~anonymous|0 (; 63 ;)
  (local $0 f64)
  (local $1 i32)
  (local $2 i32)
  f64.const 1
 ...
 (func $assembly/internal/Test/test (; 64 ;) (param $0 i32) (param $1 i32)
  local.get $0
 ...
 (func $assembly/internal/log/log<~lib/string/String> (; 65 ;) (param $0 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  global.get $assembly/internal/log/ignoreLogs
 ...
 (func $start:assembly/__tests__/performance.spec~anonymous|0~anonymous|1 (; 66 ;)
  i32.const 576
  call $assembly/internal/log/log<~lib/string/String>
 )
 (func $start:assembly/__tests__/performance.spec~anonymous|0 (; 67 ;)
  i32.const 1
 ...
 (func $start:assembly/__tests__/performance.spec (; 70 ;)
  i32.const 304
  i32.const 3
