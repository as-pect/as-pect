(module
 ...
 (func $~lib/number/isFinite<f64> (; 59 ;) (type $FUNCSIG$id) (param $0 f64) (result i32)
  local.get $0
  local.get $0
  f64.sub
  f64.const 0
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#toBeFinite (; 62 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 f64)
  (local $5 f64)
 ...
 (func $start:assembly/__tests__/toBeFinite.spec~anonymous|0~anonymous|0 (; 63 ;) (type $FUNCSIG$v)
  (local $0 i32)
  f64.const 10
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#get:not (; 65 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.const 1
  i32.store
  local.get $0
 ...
 (func $start:assembly/__tests__/toBeFinite.spec~anonymous|0~anonymous|1 (; 66 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  f64.const 10
  call $assembly/internal/Expectation/expect<f64>
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBeFinite (; 70 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#get:not (; 72 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.const 1
  i32.store
  local.get $0
 ...
 (func $~lib/util/string/compareImpl (; 81 ;) (type $FUNCSIG$iiiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
 ...
 (func $~lib/string/String.__eq (; 82 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  call $~lib/rt/pure/__retain
