(module
 ...
 (func $assembly/internal/assert/assert (; 40 ;) (param $0 i32) (param $1 i32)
  local.get $1
  call $~lib/rt/pure/__retain
  local.set $1
  local.get $0
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#toBeNaN (; 43 ;) (param $0 i32) (param $1 i32)
  (local $2 f64)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $start:assembly/__tests__/toBeNaN.spec~anonymous|0~anonymous|0 (; 44 ;)
  (local $0 i32)
  f64.const nan:0x8000000000000
 ...
 (func $start:assembly/__tests__/toBeNaN.spec~anonymous|0~anonymous|1 (; 47 ;)
  (local $0 i32)
  (local $1 i32)
  f64.const nan:0x8000000000000
  call $assembly/internal/Expectation/expect<f64>
 ...
 (func $start:assembly/__tests__/toBeNaN.spec~anonymous|0~anonymous|2 (; 49 ;)
  (local $0 i32)
  (local $1 i32)
  f64.const 10
  call $assembly/internal/Expectation/expect<f64>
 ...
 (func $start:assembly/__tests__/toBeNaN.spec~anonymous|0~anonymous|3 (; 50 ;)
  (local $0 i32)
  f64.const 10
  call $assembly/internal/Expectation/expect<f64>
  local.tee $0
 ...
 (func $start:assembly/__tests__/toBeNaN.spec~anonymous|0 (; 51 ;)
  i32.const 224
  i32.const 1
 ...
 (func $start:assembly/__tests__/toBeNaN.spec (; 54 ;)
  i32.const 192
  i32.const 5
