(module
 ...
 (data (i32.const 288) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\00\00\00\02\00\00\00")
 (table $0 2 funcref)
 ...
 (func $~lib/rt/pure/scanBlack (; 34 ;) (param $0 i32)
  local.get $0
  local.get $0
  i32.load offset=4
  i32.const 1879048192
 ...
 (func $~lib/rt/pure/scan (; 35 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/pure/collectWhite (; 36 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/tlsf/allocateBlock (; 40 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/__typeinfo (; 44 ;) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/util/memory/memcpy (; 45 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  block $break|0
