(module
 ...
 (data (i32.const 3520) "\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#toBeLessThan (; 62 ;) (param $0 i32) (param $1 f64) (param $2 i32)
  (local $3 f64)
  (local $4 i32)
  local.get $2
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|6 (; 63 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|7 (; 64 ;)
  (local $0 i32)
  f64.const 0
  call $assembly/internal/Expectation/expect<f64>
  local.tee $0
 ...
 (func $assembly/__tests__/setup/Vec3/Vec3#__lessThan (; 90 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 f64)
  (local $3 i32)
  (local $4 f64)
  local.get $1
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3>#toBeLessThan (; 91 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|8 (; 92 ;)
  (local $0 i32)
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3 | null>#toBeLessThan (; 99 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|9 (; 100 ;)
  (local $0 i32)
  i32.const 0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|10 (; 101 ;)
  (local $0 i32)
  global.get $assembly/__tests__/lessThan.spec/vec2
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3 | null>
  local.tee $0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0 (; 102 ;)
  i32.const 240
  i32.const 1
 ...
 (func $start:assembly/__tests__/lessThan.spec (; 104 ;)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
