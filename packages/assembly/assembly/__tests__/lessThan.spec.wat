(module
 ...
 (data (i32.const 3168) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00V\00e\00c\003\00")
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|1 (; 50 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 0
  call $assembly/internal/Expectation/expect<i32>
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|2 (; 52 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 42
  call $assembly/internal/Expectation/expect<i32>
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|3 (; 53 ;)
  (local $0 i32)
  i32.const 42
  call $assembly/internal/Expectation/expect<i32>
  local.tee $0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|4 (; 54 ;)
  (local $0 i32)
  (local $1 i32)
  i32.const 42
  call $assembly/internal/Expectation/expect<i32>
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|5 (; 55 ;)
  (local $0 i32)
  i32.const 42
  call $assembly/internal/Expectation/expect<i32>
  local.tee $0
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#toBeLessThan (; 63 ;) (param $0 i32) (param $1 f64) (param $2 i32)
  (local $3 f64)
  (local $4 i32)
  local.get $2
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|6 (; 64 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|7 (; 65 ;)
  (local $0 i32)
  f64.const 0
  call $assembly/internal/Expectation/expect<f64>
  local.tee $0
 ...
 (func $assembly/__tests__/setup/Vec3/Vec3#__lessThan (; 83 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 f64)
  (local $3 i32)
  (local $4 f64)
  local.get $1
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3>#toBeLessThan (; 84 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|8 (; 85 ;)
  (local $0 i32)
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3 | null>#toBeLessThan (; 92 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|9 (; 93 ;)
  (local $0 i32)
  i32.const 0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|10 (; 94 ;)
  (local $0 i32)
  global.get $assembly/__tests__/lessThan.spec/vec2
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3 | null>
  local.tee $0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0 (; 95 ;)
  i32.const 240
  i32.const 1
 ...
 (func $start:assembly/__tests__/lessThan.spec (; 98 ;)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
