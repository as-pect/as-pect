(module
 ...
 (global $~lib/heap/__heap_base i32 (i32.const 5084))
 ...
 (func $~setArgumentsLength (; 128 ;) (param $0 i32)
  local.get $0
  global.set $~argumentsLength
 )
 (func $assembly/internal/Describe/describe (; 129 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $start:assembly/__tests__/toBe.spec (; 130 ;)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
 ...
 (func $assembly/index/__ready (; 131 ;)
  i32.const 1
  global.set $assembly/internal/report/Expected/Expected.ready
 )
 (func $assembly/internal/call/__call (; 132 ;) (param $0 i32)
  i32.const 0
  global.set $~argumentsLength
  local.get $0
  call_indirect (type $none_=>_none)
 )
 (func $assembly/internal/report/Actual/__sendActual (; 133 ;)
  (local $0 i32)
  block $break|0
   block $case9|0
    block $case8|0
 ...
 (func $assembly/internal/report/Expected/__sendExpected (; 134 ;)
  (local $0 i32)
  block $break|0
   block $case11|0
    block $case10|0
 ...
 (func $assembly/internal/log/__ignoreLogs (; 135 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 136 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 137 ;) (result i32)
  i32.const 14
 )
 (func $assembly/internal/Expectation/__cleanup (; 138 ;)
  call $assembly/internal/report/Expected/Expected.clear
  call $assembly/internal/report/Actual/Actual.clear
 )
 (func $~start (; 139 ;)
 ...
 (func $~lib/rt/pure/__collect (; 140 ;)
  return
 )
 ...
 (func $~lib/array/Array<assembly/__tests__/setup/Vec3/Vec3>#__visit_impl (; 144 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<assembly/__tests__/setup/Vec3/Vec3 | null>#__visit_impl (; 145 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
        ...
        block $switch$1$case$8
         block $switch$1$case$4
          block $switch$1$case$2
           ...
           i32.sub
           i32.load
           br_table $switch$1$case$2 $switch$1$case$2 $switch$1$case$4 $switch$1$case$4 $switch$1$case$2 $switch$1$case$4 $switch$1$case$8 $switch$1$case$2 $switch$1$case$10 $switch$1$case$11 $switch$1$case$10 $switch$1$case$13 $switch$1$case$2 $switch$1$case$2 $switch$1$case$16 $switch$1$default
          end
          return
         end
         br $block$4$break
