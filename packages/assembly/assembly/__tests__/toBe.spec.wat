(module
 ...
 (func $assembly/internal/report/Actual/Actual.report<assembly/__tests__/setup/Vec3/Vec3> (; 75 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  drop
 ...
 (func $assembly/internal/report/Expected/Expected.report<assembly/__tests__/setup/Vec3/Vec3> (; 76 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  drop
 ...
 (func $start:assembly/__tests__/toBe.spec~anonymous|0~anonymous|8 (; 83 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 0
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
  local.tee $0
 ...
 (func $start:assembly/__tests__/toBe.spec~anonymous|0~anonymous|9 (; 84 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  i32.const 0
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
 ...
 (func $start:assembly/__tests__/toBe.spec~anonymous|0~anonymous|10 (; 85 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  global.get $assembly/__tests__/toBe.spec/vec1
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
 ...
 (func $start:assembly/__tests__/toBe.spec~anonymous|0~anonymous|11 (; 86 ;) (type $FUNCSIG$v)
  (local $0 i32)
  global.get $assembly/__tests__/toBe.spec/vec1
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
  local.tee $0
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#constructor (; 87 ;) (type $FUNCSIG$iid) (param $0 i32) (param $1 f64) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 16
 ...
 (func $assembly/internal/Expectation/expect<f64> (; 88 ;) (type $FUNCSIG$id) (param $0 f64) (result i32)
  i32.const 0
  local.get $0
  call $assembly/internal/Expectation/Expectation<f64>#constructor
 )
 (func $assembly/internal/report/Actual/Actual.report<f64> (; 89 ;) (type $FUNCSIG$vd) (param $0 f64)
  call $assembly/internal/report/Actual/getStackTrace
  global.set $assembly/internal/report/Actual/Actual.stackTrace
  i32.const 2
  global.set $assembly/internal/report/Actual/Actual.type
 ...
 (func $assembly/internal/report/Expected/Expected.report<f64> (; 90 ;) (type $FUNCSIG$vdi) (param $0 f64) (param $1 i32)
  global.get $assembly/internal/report/Expected/Expected.ready
  i32.eqz
  if
   call $assembly/internal/report/Expected/reportInvalidExpectCall
 ...
 (func $assembly/internal/Expectation/Expectation<f64>#toBe (; 91 ;) (type $FUNCSIG$vidi) (param $0 i32) (param $1 f64) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 f64)
  (local $6 f64)
 ...
 (func $start:assembly/__tests__/toBe.spec (; 98 ;) (type $FUNCSIG$v)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
