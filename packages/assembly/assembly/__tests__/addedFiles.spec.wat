(module
 ...
 (func $assembly/internal/Box/Box<i32>#constructor (; 27 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32> (; 28 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $1
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32>|trampoline (; 33 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  block $2of2
   block $1of2
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 41 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $2
  call $~lib/rt/pure/__retain
  local.set $2
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 42 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0 (; 45 ;)
  i32.const 240
  i32.const 1
  call $assembly/internal/Test/it
 )
 (func $assembly/internal/Test/describe (; 46 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  i32.const 1
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 47 ;)
  i32.const 192
  i32.const 3
 ...
 (func $~lib/map/Map<usize,i32>#__visit_impl (; 57 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 58 ;) (param $0 i32) (param $1 i32)
  nop
 )
