(module
 ...
 (data (i32.const 560) "\07\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\98\04\01\00\00\00\00\00\10\00\00\00\00\00\00\00\93\00\00\00\02\00\00\00")
 ...
 (func $assembly/internal/Reflect/Reflect.toHostValue<i32> (; 31 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $assembly/internal/Reflect/Reflect.toHostValue<i32>|trampoline (; 36 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  block $1of1
   block $0of1
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 45 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0 (; 47 ;)
  i32.const 240
  i32.const 1
 ...
 (func $assembly/internal/Describe/describe (; 49 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 50 ;)
  i32.const 192
  i32.const 2
