(module
 ...
 (table $0 4 funcref)
 (elem (i32.const 1) $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 $start:assembly/internal/noOp~anonymous|0 $start:assembly/__tests__/addedFiles.spec~anonymous|0)
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32> (; 27 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  local.get $1
  call $~lib/rt/pure/__retain
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<i32>|trampoline (; 32 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  block $1of1
   block $0of1
 ...
 (func $assembly/internal/Actual/Actual.report<i32> (; 35 ;) (param $0 i32)
  (local $1 i32)
  i32.const 1
  global.set $~argumentsLength
  local.get $0
 ...
 (func $assembly/internal/Expected/Expected.report<i32> (; 36 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  i32.const 1
  global.set $~argumentsLength
  local.get $0
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 40 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $2
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 41 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0 (; 44 ;)
  i32.const 240
  i32.const 1
  call $assembly/internal/Test/it
 )
 (func $assembly/internal/Test/describe (; 45 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  i32.const 1
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 46 ;)
  i32.const 192
  i32.const 3
