(module
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 51 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 52 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0 (; 54 ;)
  i32.const 240
  i32.const 1
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 57 ;)
  i32.const 192
  i32.const 2
 ...
 (func $assembly/internal/report/Actual/__sendActual (; 60 ;)
  (local $0 i32)
  block $break|0
   block $case9|0
    block $case8|0
 ...
 (func $assembly/internal/report/Expected/__sendExpected (; 61 ;)
  (local $0 i32)
  block $break|0
   block $case11|0
    block $case10|0
 ...
 (func $assembly/internal/log/__ignoreLogs (; 62 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 63 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 64 ;) (result i32)
  i32.const 4
 )
 (func $assembly/internal/Expectation/__cleanup (; 65 ;)
  call $assembly/internal/report/Expected/Expected.clear
  call $assembly/internal/report/Actual/Actual.clear
 )
 (func $~start (; 66 ;)
 ...
 (func $~lib/rt/pure/decrement (; 69 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/rt/pure/__visit (; 70 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
