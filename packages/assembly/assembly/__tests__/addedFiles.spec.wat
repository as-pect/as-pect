(module
 ...
 (func $assembly/internal/Reflect/Reflect.toHostValue<i32> (; 30 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $assembly/internal/Reflect/Reflect.toHostValue<i32>|trampoline (; 35 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  block $1of1
   block $0of1
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 43 ;)
  (local $0 i32)
 ...
 (func $assembly/internal/Describe/describe (; 47 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 48 ;)
  i32.const 192
  i32.const 2
  call $assembly/internal/Describe/describe
 )
 (func $assembly/index/__ready (; 49 ;)
  i32.const 1
  global.set $assembly/internal/Expected/Expected.ready
 )
 (func $assembly/internal/call/__call (; 50 ;) (param $0 i32)
  i32.const 0
  global.set $~argumentsLength
  local.get $0
  call_indirect (type $none_=>_none)
 )
 (func $assembly/internal/log/__ignoreLogs (; 51 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 52 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 53 ;) (result i32)
  i32.const 6
 )
 (func $~start (; 54 ;)
  global.get $~started
 ...
 (func $~lib/map/Map<usize,i32>#__visit_impl (; 59 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 60 ;) (param $0 i32) (param $1 i32)
  nop
 )
