(module
 ...
 (data (i32.const 176) "\16\00\00\00\01\00\00\00\01\00\00\00\16\00\00\00a\00d\00d\00e\00d\00 \00f\00i\00l\00e\00s\00")
 (data (i32.const 224) "N\00\00\00\01\00\00\00\01\00\00\00N\00\00\00s\00h\00o\00u\00l\00d\00 \00r\00e\00a\00d\00 \00g\00l\00o\00b\00a\00l\00s\00 \00f\00r\00o\00m\00 \00i\00n\00c\00l\00u\00d\00e\00d\00 \00f\00i\00l\00e\00s\00")
 (data (i32.const 320) "L\00\00\00\01\00\00\00\01\00\00\00L\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00i\00n\00t\00e\00r\00n\00a\00l\00/\00c\00o\00m\00p\00a\00r\00i\00s\00o\00n\00/\00a\00s\00s\00e\00r\00t\00.\00t\00s\00")
 (data (i32.const 416) "\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00")
 (data (i32.const 432) "\05\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\00\00\00\02\00\00\00")
 ...
 (func $~lib/rt/pure/increment (; 42 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.set $1
 ...
 (func $~lib/rt/pure/__retain (; 43 ;) (param $0 i32) (result i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.gt_u
  if
 ...
 (func $~lib/rt/pure/__release (; 44 ;) (param $0 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.gt_u
  if
 ...
 (func $assembly/internal/report/Expected/Expected.report<i32> (; 48 ;) (param $0 i32) (param $1 i32)
 ...
 (func $assembly/internal/comparison/assert/assert (; 49 ;) (param $0 i32) (param $1 i32)
  local.get $1
  call $~lib/rt/pure/__retain
  local.set $1
  local.get $0
 ...
 (func $assembly/internal/comparison/exactComparison/exactComparison<i32> (; 50 ;) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  local.get $3
  call $~lib/rt/pure/__retain
  local.set $3
  local.get $0
 ...
 (func $assembly/internal/Expectation/Expectation<i32>#toBe (; 53 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $2
  call $~lib/rt/pure/__retain
  local.set $2
  local.get $0
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0~anonymous|0 (; 54 ;)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/addedFiles.spec~anonymous|0 (; 56 ;)
  i32.const 240
  i32.const 1
 ...
 (func $assembly/internal/Describe/describe (; 58 ;) (param $0 i32) (param $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
  local.get $0
 ...
 (func $start:assembly/__tests__/addedFiles.spec (; 59 ;)
  i32.const 192
  i32.const 2
  call $assembly/internal/Describe/describe
 )
 (func $assembly/index/__ready (; 60 ;)
  i32.const 1
  global.set $assembly/internal/report/Expected/Expected.ready
 )
 (func $assembly/internal/call/__call (; 61 ;) (param $0 i32)
  i32.const 0
  global.set $~argumentsLength
  local.get $0
  call_indirect (type $none_=>_none)
 )
 (func $assembly/internal/report/Actual/__sendActual (; 62 ;)
  (local $0 i32)
  block $break|0
   block $case9|0
    block $case8|0
 ...
 (func $assembly/internal/report/Expected/__sendExpected (; 63 ;)
  (local $0 i32)
  block $break|0
   block $case11|0
    block $case10|0
 ...
 (func $assembly/internal/Expectation/__cleanup (; 67 ;)
  call $assembly/internal/report/Expected/Expected.clear
  call $assembly/internal/report/Actual/Actual.clear
 )
 (func $~start (; 68 ;)
 ...
 (func $~lib/rt/tlsf/freeBlock (; 70 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $1
  i32.load
  local.set $2
 ...
 (func $~lib/rt/pure/decrement (; 71 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=4
 ...
 (func $~lib/rt/pure/__visit (; 72 ;) (param $0 i32) (param $1 i32)
  local.get $0
  global.get $~lib/heap/__heap_base
  i32.lt_u
  if
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 73 ;) (param $0 i32) (param $1 i32)
  nop
 )
 (func $~lib/rt/__visit_members (; 74 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  block $block$4$break
