...
describe("toBeFinite", () => {
  ...
  it("should expect normal float values to be finite", () => {
    expect(10.0).toBeFinite("10.0 is finite");
  });
  ...
  it("should expect infinity not to be finite", () => {
    expect(Infinity).not.toBeFinite("Infinity is not finite by definition");
  });
  ...
  it("should expect NaN not to be finite", () => {
    expect(NaN).not.toBeFinite("Infinity is not finite by definition");
  });
