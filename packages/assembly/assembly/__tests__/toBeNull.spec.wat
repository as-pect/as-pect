(module
 ...
 (data (i32.const 2688) "\0b\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\98\04\01\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\93\00\00\00\02\00\00\00")
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3 | null>#constructor (; 29 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $1
 ...
 (func $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3 | null> (; 30 ;) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  call $~lib/rt/pure/__retain
  local.set $0
 ...
 (func $assembly/internal/RTrace/RTrace.sizeOf (; 35 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 16
  i32.sub
  i32.load offset=12
 ...
 (func $~lib/staticarray/StaticArray<i64>#get:length (; 43 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 16
  i32.sub
  i32.load offset=12
 ...
 (func $~lib/staticarray/StaticArray<i64>#indexOf (; 44 ;) (param $0 i32) (param $1 i64) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $0
 ...
 (func $~lib/staticarray/StaticArray<i64>#includes (; 45 ;) (param $0 i32) (param $1 i64) (param $2 i32) (result i32)
  local.get $0
  local.get $1
  local.get $2
       ...
       block $switch$1$case$6
        block $switch$1$case$4
         block $switch$1$case$2
          ...
          i32.sub
          i32.load
          br_table $switch$1$case$2 $switch$1$case$2 $switch$1$case$4 $switch$1$case$2 $switch$1$case$6 $switch$1$case$7 $switch$1$case$8 $switch$1$case$2 $switch$1$case$6 $switch$1$case$2 $switch$1$case$12 $switch$1$default
         end
         return
        end
        br $block$4$break
