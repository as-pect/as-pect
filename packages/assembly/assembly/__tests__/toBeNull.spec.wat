(module
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<~lib/string/String> (; 44 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<f64> (; 46 ;) (param $0 f64) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  local.get $1
 ...
 (func $assembly/__tests__/setup/Vec3/Vec3#__aspectAddReflectedValueKeyValuePairs (; 47 ;) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  local.get $2
  call $~lib/rt/pure/__retain
  local.set $2
  local.get $1
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<assembly/__tests__/setup/Vec3/Vec3 | null> (; 48 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  local.get $0
  call $~lib/rt/pure/__retain
 ...
 (func $assembly/internal/Reflect/Reflect.toReflectedValue<assembly/__tests__/setup/Vec3/Vec3 | null>|trampoline (; 51 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  block $2of2
   block $1of2
 ...
 (func $start:assembly/__tests__/toBeNull.spec~anonymous|0 (; 67 ;)
  i32.const 224
  i32.const 1
 ...
 (func $start:assembly/__tests__/toBeNull.spec (; 70 ;)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
 ...
 (func $assembly/internal/log/__ignoreLogs (; 73 ;) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 74 ;)
  i32.const 0
  global.set $assembly/internal/RTrace/RTrace.enabled
 )
 (func $assembly/internal/RTrace/__getUsizeArrayId (; 75 ;) (result i32)
  i32.const 7
 )
 (func $~start (; 76 ;)
  global.get $~started
 ...
 (func $~lib/map/Map<usize,i32>#__visit_impl (; 81 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
  local.get $1
 ...
 (func $~lib/array/Array<usize>#__visit_impl (; 82 ;) (param $0 i32) (param $1 i32)
  nop
 )
 (func $~lib/rt/__visit_members (; 83 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  block $block$4$break
