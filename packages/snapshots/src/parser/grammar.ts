...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {
      name: "lines$ebnf$1",
      symbols: ["lines$ebnf$1", "lines$ebnf$1$subexpression$1"],
      postprocess: d => d[0].concat([d[1]]),
    },
    {
      name: "lines",
      symbols: ["line", "lines$ebnf$1"],
      postprocess: d => [d[0]].concat(d[1].map((e: any) => e[1])),
    },
    {
      name: "line$string$1",
      symbols: [
    ...
    {
      name: "string$ebnf$1",
      symbols: ["string$ebnf$1", "string$ebnf$1$subexpression$1"],
      postprocess: d => d[0].concat([d[1]]),
    },
    {
      name: "string",
