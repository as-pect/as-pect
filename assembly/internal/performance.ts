...
@external("__aspect", "performanceEnabled") @global
...
// @ts-ignore decorators are valid here
@external("__aspect", "reportMedian") @global
export declare function reportMedian(value: bool): void;

// @ts-ignore decorators are valid here
@external("__aspect", "reportStdDev") @global
export declare function reportStdDev(value: bool): void;

// @ts-ignore decorators are valid here
@external("__aspect", "reportMax") @global
