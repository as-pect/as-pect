...
describe("GreaterThanOrEqualTo (>=)", (): void => {
  ...
  it("should throw when the expected value is less than the actual value", (): void => {
    ...
    }).toThrow("Negated toBeGreaterThanOrEqualTo assertions should throw when the actual value is less than the expected value.");
  });
   ...
   */
  it("should throw when the expected value is not greater than or equal to the actual value", (): void => {
    expectFn((): void => {
  ...
  it("should throw if the actual value is null", (): void => {
    ...
    }).toThrow("The toBeGreaterThanOrEqualTo function should throw if the actual value is null.");
  });
  ...
  it("should throw if the expected value is null", (): void => {
    ...
    }).toThrow("The toBeGreaterThanOrEqualTo function should throw if the expected value is null.");
  });
});
