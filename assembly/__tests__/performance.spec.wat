(module
 ...
 (start $start)
 (func $start:assembly/__tests__/performance.spec~anonymous|0~anonymous|0 (; 6 ;) (type $FUNCSIG$v)
  (local $0 i32)
  block $break|0
   i32.const 0
   local.set $0
 ...
 (func $assembly/internal/Test/test (; 7 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $assembly/internal/Test/reportTest
 )
 (func $~lib/internal/string/compareUnsafe (; 8 ;) (type $FUNCSIG$iiiiii) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  i32.const 0
 ...
 (func $start:assembly/__tests__/performance.spec~anonymous|0~anonymous|1 (; 10 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 224
  local.set $0
  local.get $0
 ...
 (func $start:assembly/__tests__/performance.spec~anonymous|0 (; 11 ;) (type $FUNCSIG$v)
  i32.const 1
 ...
 (func $start:assembly/internal/noOp~anonymous|0 (; 12 ;) (type $FUNCSIG$v)
  nop
 )
 (func $assembly/internal/Describe/describe (; 13 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  local.get $0
 ...
 (func $start:assembly/__tests__/performance.spec (; 14 ;) (type $FUNCSIG$v)
  i32.const 8
  i32.const 3
  call $assembly/internal/Describe/describe
 )
 (func $start:~lib/allocator/arena (; 15 ;) (type $FUNCSIG$v)
 ...
 (func $start:assembly/index (; 16 ;) (type $FUNCSIG$v)
