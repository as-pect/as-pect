(module
 ...
 (func $~lib/number/isNaN<f64> (; 80 ;) (type $FUNCSIG$id) (param $0 f64) (result i32)
  local.get $0
  local.get $0
  f64.ne
 )
 ...
 (func $~lib/arraybuffer/ArrayBuffer#get:byteLength (; 88 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  local.get $0
  i32.const 16
  i32.sub
  i32.load offset=12
