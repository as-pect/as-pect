(module
 ...
 (func $assembly/__tests__/setup/Vec3/Vec3#magnitude (; 78 ;) (type $FUNCSIG$di) (param $0 i32) (result f64)
  local.get $0
  f64.load
  local.get $0
  f64.load
 ...
 (func $assembly/__tests__/setup/Vec3/Vec3#__lessThan (; 79 ;) (type $FUNCSIG$iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 f64)
  (local $3 f64)
  (local $4 i32)
  local.get $1
 ...
 (func $assembly/internal/Expectation/Expectation<assembly/__tests__/setup/Vec3/Vec3>#toBeLessThan (; 80 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|8 (; 81 ;) (type $FUNCSIG$v)
  (local $0 i32)
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|9 (; 82 ;) (type $FUNCSIG$v)
  (local $0 i32)
  i32.const 0
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
  local.tee $0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0~anonymous|10 (; 83 ;) (type $FUNCSIG$v)
  (local $0 i32)
  global.get $assembly/__tests__/lessThan.spec/vec2
  call $assembly/internal/Expectation/expect<assembly/__tests__/setup/Vec3/Vec3>
  local.tee $0
 ...
 (func $start:assembly/__tests__/lessThan.spec~anonymous|0 (; 84 ;) (type $FUNCSIG$v)
  i32.const 312
  i32.const 1
 ...
 (func $start:assembly/__tests__/lessThan.spec (; 87 ;) (type $FUNCSIG$v)
  i32.const 0
  f64.const 1
  f64.const 2
  f64.const 3
 ...
 (func $assembly/index/__ready (; 88 ;) (type $FUNCSIG$v)
  i32.const 1
 ...
 (func $assembly/internal/report/reportActual/__sendActual (; 90 ;) (type $FUNCSIG$v)
  (local $0 i32)
  block $break|0
   block $case6|0
    block $case5|0
 ...
 (func $assembly/internal/report/reportExpected/__sendExpected (; 91 ;) (type $FUNCSIG$v)
  (local $0 i32)
  block $break|0
   block $case9|0
    block $case8|0
 ...
 (func $assembly/internal/log/__ignoreLogs (; 92 ;) (type $FUNCSIG$vi) (param $0 i32)
  local.get $0
  i32.const 0
  i32.ne
  global.set $assembly/internal/log/ignoreLogs
 )
 (func $assembly/internal/RTrace/__disableRTrace (; 93 ;) (type $FUNCSIG$v)
  i32.const 0
